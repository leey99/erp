						...
						<div style="margin:10px 20px 20px 20px;min-height:480px;">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td width="130"><img src="images/top05_04.gif" border="0"></td>
									<td></td>
								</tr>
...
if($member['mb_level'] >= 8) {
	$url_save = "javascript:checkData('total_insure_update.php');";
} else {
...
?>
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" style="">
									<tr>
										...
										<td nowrap class="tdrow" width="464" colspan="">
<?
//보험료신고 DB
...
<? } ?>
											<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=images/btn_lt.gif></td><td background=images/btn_bg.gif class=ftbutton1 nowrap><a href="./total_insure_list.php?<?=$qstr?>&page=<?=$page?>" target="">목 록</a></td><td><img src=images/btn_rt.gif></td><td width=2></td></tr></table>
<?
if($w == "u") {
?>
