...
?>
									...
									<tr>
										...
										<td class="tdrow" colspan="3">
<?
if($row_log['work_forenoon']) echo "<pre style='word-wrap:break-word;white-space:pre-wrap;white-space:-moz-pre-wrap;white-space:-pre-wrap;white-space:-o-pre-wrap;word-break:break-all;'>".url_auto_link($row_log['work_forenoon'])."</pre>";
?>
										</td>
									</tr>
									<tr>
										...
										<td class="tdrow" colspan="3">
<?
if($row_log['work_afternoon']) echo "<pre style='word-wrap:break-word;white-space:pre-wrap;white-space:-moz-pre-wrap;white-space:-pre-wrap;white-space:-o-pre-wrap;word-break:break-all;'>".url_auto_link($row_log['work_afternoon'])."</pre>";
?>
										</td>
									</tr>
									<tr>
...
<?
//URL 자동 링크
//include "inc/url_auto_link.php";
if($row_log['work_night']) echo "<pre style='word-wrap:break-word;white-space:pre-wrap;white-space:-moz-pre-wrap;white-space:-pre-wrap;white-space:-o-pre-wrap;word-break:break-all;'>".url_auto_link($row_log['work_night'])."</pre>";
?>
										</td>
									</tr>
<?
//스케줄 표시 권한 : 정경용 부장, 김국진 과장, 임영진 주임, 최희용 주임 (영업), 송인혜, 김미정 (TM), 김근호 160630
if($row_log['drafter_code'] == 110 || $row_log['drafter_code'] == 26 || $row_log['drafter_code'] == 122 || $row_log['drafter_code'] == 126 || $row_log['drafter_code'] == 1030 || $row_log['drafter_code'] == 1000 || $row_log['drafter_code'] == 134) {
?>
									<tr>
...
//]]>
											...
											<iframe id="popup_schedule_iframe" src="popup_schedule.php?manage_code=<?=$row_log['drafter_code']?>&amp;search_sday=<?=$row_log['subject_date']?>" frameborder="0" width="100%" height="200" onload="resizeFrame(this)" scrolling="no" style="margin:10px 0 0 0"></iframe>
										</td>
									</tr>
<?
}
?>
									<tr>
										...
										<td class="tdrow" colspan="3" style="min-height:40px;">
<?
if($row_log['work_plan']) echo "<pre style='word-wrap:break-word;white-space:pre-wrap;white-space:-moz-pre-wrap;white-space:-pre-wrap;white-space:-o-pre-wrap;word-break:break-all;'>".$row_log['work_plan']."</pre>";
?>
										</td>
									</tr>
									<tr>
										...
										<td class="tdrow" colspan="3">
<?
if($row_log['memo']) echo "<pre style='word-wrap:break-word;white-space:pre-wrap;white-space:-moz-pre-wrap;white-space:-pre-wrap;white-space:-o-pre-wrap;word-break:break-all;'>".url_auto_link($row_log['memo'])."</pre>";
?>
										</td>
									</tr>
								</table>
...
<?
//기안일
$subject_date = $row_log['subject_date'];
//기안자 코드, 기안자 성명(거래처 현황 표시) 160509
$drafter_code = $row_log['drafter_code'];
$drafter_name = $row_log['drafter_name'];
//경리부 보고서, 101 전정애
if($row_log['drafter_code'] == 101) {
	include "./inc/business_log_101.php";
//사무위탁, 키즈노무 보고서, 23 임현미
} else if($row_log['drafter_code'] == 23) {
	include "./inc/business_log_23.php";
//TM부 보고서, 1030 송인혜, 1000 김미정
} else if($row_log['drafter_code'] == 1030 || $row_log['drafter_code'] == 1000) {
	include "./inc/business_log_1030.php";
//기업지원과 보고서, 122 임영진, 126 최희용
} else if($row_log['drafter_code'] == 122 || $row_log['drafter_code'] == 126) {
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" style="">
									<tr>
										...
										<td   class="tdrow" width="320">
											<a href="files/business_log/<?=$filename[1]?>" target="_blank"><?=$filename[1]?></a>
										</td>
										...
										<td   class="tdrow" >
											<a href="files/business_log/<?=$filename[2]?>" target="_blank"><?=$filename[2]?></a>
										</td>
									</tr>
									<tr id="file_tr2" style="<? if(!$filename[3] && !$filename[4]) echo "display:none"; ?>">
										...
										<td   class="tdrow" >
											<a href="files/business_log/<?=$filename[3]?>" target="_blank"><?=$filename[3]?></a>
										</td>
										...
										<td   class="tdrow" >
											<a href="files/business_log/<?=$filename[4]?>" target="_blank"><?=$filename[4]?></a>
										</td>
									</tr>
									<tr id="file_tr3" style="<? if(!$filename[5] && !$filename[6]) echo "display:none"; ?>">
										...
										<td   class="tdrow" >
											<a href="files/business_log/<?=$filename[5]?>" target="_blank"><?=$filename[5]?></a>
										</td>
										...
										<td   class="tdrow" >
											<a href="files/business_log/<?=$filename[6]?>" target="_blank"><?=$filename[6]?></a>
										</td>
									</tr>
									<tr id="file_tr4" style="<? if(!$filename[7] && !$filename[8]) echo "display:none"; ?>">
										...
										<td   class="tdrow" >
											<br/><a href="files/business_log/<?=$filename[7]?>" target="_blank"><?=$filename[7]?></a>
										</td>
										...
										<td   class="tdrow" >
											<br/><a href="files/business_log/<?=$filename[8]?>" target="_blank"><?=$filename[8]?></a>
										</td>
									</tr>
								</table>
								<div style="height:10px;font-size:0px"></div>
...
if($row_log['drafter_code'] == $drafter_code) {
	$modify_url = "groupware_business_write.php?id=".$id."&w=u&page=".$page."&".$qstr;
