...
if($member['mb_level'] > 6 || $search_ok == "ok") {
	...
	if($member['mb_id'] == "gs0001") {
		$sql_search = " where a.com_code = b.com_code and a.com_code = c.com_code ";
		$stx_service_support_staff = "대구남부";
	} else {
...
function checkcomma(inputVal, type, keydown) {		// inputVal은 천단위에 , 표시를 위해 가져오는 값
	var main = document.searchForm;			// 여기서 type 은 해당하는 값을 넣기 위한 위치지정 index
	var chk		= 0;				// chk 는 천단위로 나눌 길이를 check
	var chk2	= 0;
	var chk3	= 0;
	var share	= 0;				// share 200,000 와 같이 3의 배수일 때를 구분하기 위한 변수
			...
			<div style="margin:10px 20px 20px 20px;min-height:480px;">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td><a href="./settlement_report.php"><img src="images/top03_02.gif" border="0" alt="결산보고서" /></a></td>
						<td>
<?
$title_main_no = "03";
						...
						<td valign="top" style="padding:10px 0 0 0">
							...
							<form name = "searchForm" id="searchForm" method="get">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" style="">
									<tr>
										<td nowrap class="tdrowk"><img src="images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">결산기간</td>
...
?>
										...
										<td nowrap class="tdrowk"><img src="images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">용역비</td>
										<td nowrap class="tdrow" colspan="">
											<select name="stx_allowance_pay" class="selectfm">
												<option value="">전체</option>
												<option value="1" <? if($stx_allowance_pay == 1) echo "selected"; ?>>입력</option>
												<option value="2" <? if($stx_allowance_pay == 2) echo "selected"; ?>>미입력</option>
											</select>
										</td>
<?
//본사
...
?>
										...
										<td nowrap class="tdrowk"><img src="images/icon_02.gif" width="2" height="2" style="margin:0 5 3 0">업무지원</td>
										<td nowrap class="tdrow">
											<select name="stx_service_support_staff" class="selectfm">
												<option value="">제외</option>
												<option value="대구남부" <? if($stx_service_support_staff == "대구남부") echo "selected"; ?>>대구남부</option>
												<option value="황희경 팀장" <? if($stx_service_support_staff == "황희경 팀장") echo "selected"; ?>>황희경 팀장</option>
											</select>
										</td>
...
<?
//지사 stx_man_cust_name 데이터 설정 161111
} else {
	$stx_man_cust_name = $member['mb_profile'];
?>
...
?>
									<tr>
										...
										<td class="tdhead_center"></td>
										<td class="tdhead_center"></td>
										<td class="tdhead_center" colspan="4">합계</td>
