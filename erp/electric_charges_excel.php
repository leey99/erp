...
if($member['mb_level'] > 6) $cell = array("No","등록일시","사업장명","업태","주소","전화번호","대표자HP","이메일","대표자","고객번호","법인등록번호","주민등록번호","계약전력","전기료(1년간)","절감예상금액1","한전불입금1","공사비1","수수료1","절감예상금액2","한전불입금2","공사비2","수수료2","처리현황","지사","담당자","상담메모","처리결과");
