...
<div style="padding:0 0 5px 0;">
	<table width="604" border="0" cellpadding="0" cellspacing="1" class="bgtable" style="" align="center">
		<tr>
			...
			<td class="tdhead_center" width="66" rowspan="">위탁현황</td>
			<td class="tdhead_center" width="72" rowspan="">수임일자</td>
			<td class="tdhead_center" width="60" rowspan="">위탁번호</td>
			<td class="tdhead_center" width="72" rowspan="">해지일자</td>
		</tr>
<?
// 리스트 출력
