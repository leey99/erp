...
$sub_title = "수입/지출";
$g4[title] = $sub_title." : 결산관리 : ".$easynomu_name;
						...
						<div style="margin:10px 20px 20px 20px;min-height:480px;">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td width="129"><a href="account_list.php"><img src="images/menu05_top01_on.gif" border="0"></a></td>
									<td width="129"><a href="account_trade.php"><img src="images/menu05_top02_off.gif" border="0"></a></td>
									<td width="129"><a href="account_sale.php"><img src="images/menu05_top03_off.gif" border="0"></a></td>
									<td width="129"><a href="account_statistics.php"><img src="images/menu05_top04_off.gif" border="0"></a></td>
									<td></td>
								</tr>
