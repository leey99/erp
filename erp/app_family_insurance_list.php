...
//지원금 신청 : 가족보험료환급 (기본 검색) / 18->16 변경
$sql_search .= " and ( c.application_kind = '16' ) ";
...
$qstr .= "&stx_reapplication_done=".$stx_reapplication_done;
?>
<html>
<head>
...
<? } ?>
					...
					<tr>
						...
						<td nowrap class="tdrowk"><img src="images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">최종완료</td>
						<td nowrap class="tdrow" colspan="3">
			...
			<form name="dataForm" method="post">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable" style="">
					<tr>
						...
						<td class="tdhead_center" width="50" rowspan="2">지점</td>
						<td class="tdhead_center" width="90" rowspan="2">담당자</td>
						<td class="tdhead_center" width="72" rowspan="2">접수일자</td>
						...
						<td class="tdhead_center" width="60" rowspan="2">신청기간<br></td>
						<td class="tdhead_center" width="72" rowspan="2">재접수일자</td>
...
for ($i=0; $row=sql_fetch_array($result); $i++) {
  ...
  $list = $i%2;
	...
	if($member['mb_level'] > 6 || $row['damdang_code'] == $member['mb_profile']) {
		$com_view = "app_family_insurance_view.php?id=$id&w=u&$qstr&page=$page";
	} else {
...
?>
					<tr class="list_row_now_wh" onMouseOver="this.className='list_row_over';" onMouseOut="this.className='list_row_now_wh';">
						...
						<td class="ltrow1_right_h22_padding" style="<?=$client_receipt_date_color?>"><?=$client_receipt_date?><br/><div style="color:blue;text-align:right;"><?=$client_receipt_fee?></span></td>
						<td class="ltrow1_right_h22_padding" style="<?=$main_receipt_date_color?>"><?=$main_receipt_date?><br/><div style="color:blue;text-align:right;"><?=$main_receipt_fee?></span></td>
