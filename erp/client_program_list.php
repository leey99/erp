			...
			<div style="margin:10px 20px 20px 20px;min-height:480px;">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td><a href="client_program_list.php"><img src="images/top18_01.gif" border="0" alt="이지노무" /></a></td>
						<td>
<?
$title_main_no = "18";
											...
											<table width="100%" border="0" cellpadding="0" cellspacing="0" style="table-layout:fixed">
												<tr>
													<td align="center">
														...
														<a href="client_program_excel.php?<?=$qstr?>"><img src="./images/btn_excel_print_big.png" border="0" /></a>
													</td>
												</tr>
											</table>
										</form>
...
for ($i=0; $row=mysql_fetch_assoc($result); $i++) {
  ...
  $list = $i%2;
	...
	if($member['mb_level'] > 6 || $row['damdang_code'] == $member['mb_profile'] || $row['damdang_code2'] == $member['mb_profile']) {
		$com_view = "client_program_view.php?id=$id&w=u&page=$page&$qstr&$stx_qstr";
	} else {
