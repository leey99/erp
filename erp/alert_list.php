...
if($member['mb_level'] > 6 || $search_ok == "ok") {
	...
	if($member['mb_level'] == 7) {
		//수신자 ID, 등록자 코드, 담당매니저 코드(광주지사장 의견) 160322
...
//전기공사 업체 권한 160706
	...
	//딜러 권한 : 수신자 ID, 등록자 코드, 담당매니저 코드(광주지사장 의견) 160322 / 영업사원 160408
					...
					<td onmouseover="showM('900')" valign="top">
						<div style="margin:10px 20px 20px 20px;min-height:480px;">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td width="100"><img src="images/top_alert.gif" border="0" alt="알림" /></td>
									<td><a href="<?=$php_self?>"><img src="images/top_alert_all.gif" border="0" alt="전체" /></a></td>
									<td>
<?
//본사만 표시
...
*/
	...
	for($sta=0; $sta<=count($send_to_array);$sta++) {
		if($send_to_array[0]) {
			...
			if($send_to_array[$sta] == "kcmc1007") $send_to = "사무위탁<br />";
			else if($send_to_array[$sta] == "kcmc1006") $send_to .= "사업주훈련<br />";
			else if($send_to_array[$sta] == "kcmc1008") $send_to .= "대리인선임<br />";
			else if($send_to_array[$sta] == "manager") $send_to .= "지원금<br />";
			else if($send_to_array[$sta] == "kcmc1009") $send_to .= "이지노무<br />";
			else if($send_to_array[$sta] == "branch") $send_to .= "담당지사<br />";
			else if($send_to_array[$sta] == "kcmc1001") $send_to .= "총괄관리<br />";
			else if($send_to_array[$sta] == "electric") $send_to .= "전기담당<br />";
			else if($send_to_array[$sta] == "si4n") $send_to .= "4대보험<br />";
		} else {
			$send_to = "전체";
		}
	}
