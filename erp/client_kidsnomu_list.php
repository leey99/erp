...
//기본 검색어
$sql_search .= " and b.easynomu_yn = '2' ";
...
$qstr .= "&stx_comp_name=".$stx_comp_name."&stx_t_no=".$stx_t_no."&stx_biz_no=".$stx_biz_no."&stx_boss_name=".$stx_boss_name."&stx_comp_tel=".$stx_comp_tel."&stx_count=".$stx_count."&stx_comp_gubun1=".$stx_comp_gubun1."&stx_comp_gubun2=".$stx_comp_gubun2."&stx_comp_gubun3=".$stx_comp_gubun3."&stx_comp_gubun4=".$stx_comp_gubun4."&stx_comp_gubun5=".$stx_comp_gubun5."&stx_comp_gubun6=".$stx_comp_gubun6."&stx_man_cust_name=".$stx_man_cust_name."&stx_man_cust_name2=".$stx_man_cust_name2."&stx_uptae=".$stx_uptae."&stx_upjong=".$stx_upjong."&search_ok=".$search_ok;
			...
			<div style="margin:10px 20px 20px 20px;min-height:480px;">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td><a href="client_kidsnomu_list.php"><img src="images/top18_02.gif" border="0" alt="키즈노무" /></a></td>
						<td>
<?
$title_main_no = "18";
...
if($member['mb_level'] > 7) {
	//echo $stx_man_cust_name;
?>
										<td nowrap class="tdrowk"><img src="images/icon_02.gif" width="2" height="2" style="margin:0 5 3 0" alt="*" />열람</td>
										<td nowrap class="tdrow">
...
?>
									...
									<tr>
										<td nowrap class="tdrowk"><img src="images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0" alt="*" />거래처구분</td>
										...
										<td nowrap class="tdrow" colspan="">
											<select name="easynomu_process" class="selectfm" onchange="">
												...
												<option value="7" <? if($easynomu_process == "7") echo "selected"; ?>>세무관리</option>
											</select>
										</td>
									</tr>
								</table>
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" style="table-layout:fixed">
									<tr>
										<td align="center">
											...
											<a href="client_kidsnomu_excel.php?<?=$qstr?>"><img src="./images/btn_excel_print_big.png" border="0" /></a>
										</td>
									</tr>
								</table>
							</form>
...
for ($i=0; $row=mysql_fetch_assoc($result); $i++) {
  ...
  $list = $i%2;
	...
	if($member['mb_level'] > 6 || $row['damdang_code'] == $member['mb_profile'] || $row['damdang_code2'] == $member['mb_profile']) {
		$com_view = "client_kidsnomu_view.php?id=$id&w=u&page=$page&$qstr&$stx_qstr";
	} else {
