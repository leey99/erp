...
<div style="padding:0 0 5px 0;">
	·<strong>상호</strong>: <?=$row['com_name']?> ·<strong>업태</strong>: <?=$row['uptae']?> ·<strong>전화번호</strong>: <?=$row['com_tel']?> ·<strong>고객번호</strong>: <?=$row['electric_charges_no']?>
</div>
...
<form name="dataForm" method="post" enctype="" style="margin:0">
	...
	<div style="padding:5px 0 0 0;">
		...
		최종수정일시 : <?=$row['electric_charges_editdt']?>
	</div>
</form>
</body>
</html>
