...
$top_sub_title = "images/top02_06.gif";
$sub_title = "감원방지기간(뷰)";
...
if($w == "u") {
	...
	//감원방지기간조회 DB
	$sql2 = " select * from com_reduction_app where com_code='$com_code' ";
	//echo $sql2;
...
function goSearch() {
	var frm = document.dataForm;
	frm.action = "reduction_application_view.php#search_result";
	frm.method = "get";
	frm.submit();
	return;
}
			...
			<div style="margin:10px 20px 20px 20px;min-height:480px;">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td><a href="reduction_application.php"><img src="<?=$top_sub_title?>" border="0" alt="<?=$sub_title?>" /></a></td>
						<td>
<?
$title_main_no = "02";
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" style="">
									<tr>
										...
										<td   class="tdrow" width="365">
											...
											<a href="files/reduction_app_file/<?=$row2['in_file_1']?>" target="_blank"><?=$row2['in_file_1']?></a>
										...
										<td   class="tdrow" >
											...
											<a href="files/reduction_app_file/<?=$row2['out_file_1']?>" target="_blank"><?=$row2['out_file_1']?></a>
...
<?
//권한별 링크값
$url_save = "javascript:checkData('reduction_application_update.php');";
?>
...
if($excel) {
	...
	$upload_path = $_SERVER["DOCUMENT_ROOT"]."/erp/files/reduction_app_file";
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" id="electric_charges_div" style="">
									<tr>
										...
										<td nowrap class="tdrow">
											<input name="stx_before_month" type="text" class="textfm" style="width:40px;ime-mode:disabled;" value="<?=$before_month?>" maxlength="2" /> 개월
											/
									...
									<tr>
										<td nowrap class="tdrowk" width="120" style="padding:6px;"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">권고사직 기간<div style="margin:4px 0 0 4px;"></div><font color="red"></font></td>
...
<?
//대상자 DB 삭제 com_reduction_app_opt
$sql_del = "select * from com_reduction_app_opt where com_code = '$id' ";
$row_del = sql_fetch($sql_del);
if($row['com_code']) sql_query("delete from com_reduction_app_opt where com_code = '$id' ");
//대상자 추출(취득자)
$k = 0;
for($i=0; $i<$in_cnt; $i++) {
	//권고사직 기간 제외
...
<?
		//대상자 DB 저장 com_reduction_app_opt
		...
		$sql_opt = " insert com_reduction_app_opt set $sql_common_opt , com_code = '$id' ";
		sql_query($sql_opt);
	}
}
//대장자 추출(취득자) 카운트
...
if(!$check_ok_id && $k2 == 0) {
	$sql_common = " update com_reduction_app set reduction_process='5' where com_code = '$id' ";
...
?>
											...
											<table border="0" cellpadding="0" cellspacing="0" style="display:inline;"><tr><td width="2"></td><td><img src="images/btn_lt.gif"></td><td background="images/btn_bg.gif" class="ftbutton1" nowrap><a href="./reduction_application_result_excel.php?idx=<?=$row2['idx']?>">엑셀저장</a></td><td><img src=images/btn_rt.gif></td><td width=2></td></tr></table>
											<table border="0" cellpadding="0" cellspacing="0" style="display:inline;"><tr><td width="2"></td><td><img src="images/btn_lt.gif"></td><td background="images/btn_bg.gif" class="ftbutton1" nowrap><a href="./reduction_application.php?page=<?=$page?>&<?=$qstr?>">목 록</a></td><td><img src=images/btn_rt.gif></td><td width=2></td></tr></table>
										</td>
									</tr>
								</table>
