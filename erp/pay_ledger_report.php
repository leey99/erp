...
?>
									...
									<input type="hidden" name="b1_text" value=" "/>
									<input type="hidden" name="b2_text" value="<?=$money_e_txt['e1']?>"/>
<?
//신고용 : e1 육아수당 기타1 / 나머지는 제외 160503
...
?>
									<input type="hidden" name="b3_text" value=" "/>
<?
}
?>
...
for ($i=0; $row=sql_fetch_array($result); $i++) {
	...
	*/
	...
	//$w_sum = round($w_sum,2);
	$w_sum = $row[workhour_total] + $w_etc;
...
?>
									...
									<input type="hidden" name="etc2" value="<?=number_format($row[etc2])?>"/>
									...
									<input type="hidden" name="money_total" value="<?=number_format($row[money_total]-($row[b2]+$row[b3]))?>"/>
									<input type="hidden" name="money_result" value="<?=number_format($row[money_result]-($row[b2]+$row[b3]))?>"/>
<?
}
//echo $i;
...
?>
									...
									<input type="hidden" name="b1_sum_t" value=" "/>
									<input type="hidden" name="b2_sum_t" value="<?=number_format($b1_sum_t)?>"/>
									<input type="hidden" name="b3_sum_t" value=" "/>
									...
									<input type="hidden" name="money_total_sum_t" value="<?=number_format($money_total_sum_t-($b2_sum_t+$b3_sum_t))?>"/>
									<input type="hidden" name="money_result_sum_t" value="<?=number_format($money_result_sum_t-($b2_sum_t+$b3_sum_t))?>"/>
