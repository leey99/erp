...
$top_sub_title = "images/top07_01_04.png";
$sub_title = "휴가신청";
$doc_code = 4;
...
function checkData(id) {
	...
	if(frm.v_start_date.value == "") {
		alert("기간(시작일)을 입력하세요.");
		frm.v_start_date.focus();
		return;
	}
	if(frm.v_end_date.value == "") {
		alert("기간(종료일)을 입력하세요.");
		frm.v_end_date.focus();
		return;
	}
	if(frm.v_tel.value == "") {
		alert("긴급연락망을 입력하세요.");
	...
	frm.action = "groupware_vacation_report_update.php";
	frm.submit();
	return;
}
...
//제목 뒷 문구
$subject_end = " ".$dept_name." ".$row_manage['name']." 휴가신청서";
...
function loadCalendar( obj )
{
	...
	function onSelect(calendar, date)
	{
		...
		//기안일 수정 시 제목에 날짜(년 월 일) 휴가신청서 입력 160419
...
<?
for($m=1;$m<count($vacation_report_kind_arry);$m++) {
?>
												<option value="<?=$m?>" <? if($row['v_code'] == $m) echo "selected"; ?> ><?=$vacation_report_kind_arry[$m]?></option>
<?
}
?>
										...
										<td class="tdrowk" width="100"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0" alt="*" />기간<font color="red">*</font></td>
										<td class="tdrow">
											<div style="float:left;">
												<input name="v_start_date" type="text" class="textfm" style="width:78px;ime-mode:disabled;float:left;background:#dddddd;" readonly value="<?=$row['work_forenoon']?>" />
												<table border="0" cellspacing="0" cellpadding="0" style="vertical-align:middle;float:left;"><tr><td width="2"></td><td><img src="./images/btn2_lt.gif" alt="[" /></td><td style="background:url('./images/btn2_bg.gif')" class="ftbutton3_white"><a href="javascript:loadCalendar(document.dataForm.v_start_date);">달력</a></td><td><img src="./images/btn2_rt.gif" alt="]" /></td> <td width="2"></td></tr></table>
											</div>
											<div style="float:left;" id="v_end_date_div">
												<div style="float:left;">~</div>
												<input name="v_end_date" type="text" class="textfm" style="width:78px;ime-mode:disabled;float:left;background:#dddddd;" readonly value="<?=$row['work_afternoon']?>" />
												<table border="0" cellspacing="0" cellpadding="0" style="vertical-align:middle;float:left;"><tr><td width="2"></td><td><img src="./images/btn2_lt.gif" alt="[" /></td><td style="background:url('./images/btn2_bg.gif')" class="ftbutton3_white"><a href="javascript:loadCalendar(document.dataForm.v_end_date);">달력</a></td><td><img src="./images/btn2_rt.gif" alt="]" /></td> <td width="2"></td></tr></table>
											</div>
										</td>
									</tr>
									<tr>
										<td class="tdrowk"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0" alt="*" />장소</td>
										<td class="tdrow" colspan="3">
											<input type="text" name="v_place" value="<?=$row['work_plan']?>" style="width:98%;" maxlength="50" />
										</td>
									</tr>
									<tr>
										<td class="tdrowk"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0" alt="*" />긴급연락망<font color="red">*</font></td>
										<td class="tdrow" colspan="3">
											<textarea name="v_tel" class="textfm" style='width:100%;height:76px;word-break:break-all;'><?=$row['work_night']?></textarea>
										</td>
									</tr>
									<tr>
