...
if($approved == "ok") echo "	alert('이미 결재하셨습니다.');\nreturn;\n";
?>
	var frm = document.dataForm;
...
if($approved == "return") echo "	alert('이미 반려하셨습니다.');\nreturn;\n";
?>
	var frm = document.dataForm;
...
echo $vacation_report_kind_arry[$v_code];
?>
										</td>
										<td class="tdrowk" width="100"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0" alt="*" />기간</td>
										<td class="tdrow">
									...
									<tr>
										<td class="tdrowk"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0" alt="*" />긴급연락망</td>
										<td class="tdrow" colspan="3">
<?
if($row_log['work_night']) echo "<pre style='word-wrap:break-word;white-space:pre-wrap;white-space:-moz-pre-wrap;white-space:-pre-wrap;white-space:-o-pre-wrap;word-break:break-all;'>".$row_log['work_night']."</pre>";
?>
										</td>
									</tr>
									<tr>
...
if($row_log['drafter_code'] == $drafter_code) {
	$modify_url = "groupware_vacation_report_write.php?id=".$id."&w=u&page=".$page."&".$qstr;
