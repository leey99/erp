			...
			<div style="margin:10px 20px 20px 20px;min-height:480px;">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td width=""><a href="<?=$_SERVER['PHP_SELF']?>"><img src="images/top02_04.gif" border="0"></a></td>
						<td>
<?
$title_main_no = "02";
...
?>
											...
											<input type="checkbox" name="search_day2" value="1" <? if($search_day2 == 1) echo "checked"; ?> style="vertical-align:middle" onclick="search_day_func(this)">종료일자
										</td>
									...
									<tr>
										<td nowrap class="tdrowk"><img src="images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">종료분기</td>
										<td nowrap class="tdrow" colspan="9">
											<select name="stx_close_year" class="selectfm" onchange="">
												<option value=""  <? if($stx_close_year == "")  echo "selected"; ?>>전체</option>
<?
for($i=2017;$i>2000;$i--) {
?>
									<option value="<?=$i?>" <? if($i == $stx_close_year) echo "selected"; ?> ><?=$i?></option>
<?
}
?>
											</select>년
											<select name="stx_close_quarter" class="selectfm" onchange="">
												<option value=""  <? if($stx_close_quarter == "")  echo "selected"; ?>>전체</option>
<?
for($i=1;$i<=4;$i++) {
?>
									<option value="<?=$i?>" <? if($i == $stx_close_quarter) echo "selected"; ?> ><?=$i?></option>
<?
}
?>
											</select>분기
...
?>
									<tr class="list_row_now_wh" onMouseOver="this.className='list_row_over';" onMouseOut="this.className='list_row_now_wh';">
										...
										<td class="ltrow1_center_h22" style="color:blue"><?=$close_kind_title?></td>
...
?>
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" style="table-layout:fixed">
									<tr>
										<td align="center">
											<a href="client_application_cycle_excel.php?<?=$qstr?>" target=""><img src="./images/btn_excel_print_big.png" border="0"></a>
										</td>
									</tr>
								</table>
							</form>
