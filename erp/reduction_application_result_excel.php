...
$sql_reduction = " select * from com_reduction_app where idx='$idx' ";
...
if( $reduction_process == ""|| $reduction_process == 1 ) {
	$sql_common = " update com_reduction_app set reduction_process='6' where idx = '$idx' ";
	sql_query($sql_common);
}
//데이터베이스
$sql_common = " from com_list_gy a, com_reduction_app_opt b ";
