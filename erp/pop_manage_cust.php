							...
							<table width=100% border=0 cellspacing=0 cellpadding=0>
								<tr>
									<td style='font-size:8pt;color:#929292;'>
										<img src="./images/title_icon.gif" align="absmiddle" style="margin:0 5px 2px 0;"><span style="font-size:9pt;color:black;">담당매니저 선택</span>
									</td>
...
?>
									...
									<option value="110" <? if($search_belong == 110) echo "selected"; ?>>제휴점</option>
									<!--<option value="111" <? if($search_belong == 111) echo "selected"; ?>>제휴점2</option>-->
									<option value="114" <? if($search_belong == 114) echo "selected"; ?>>제휴점5</option>
								</select>
<?
} else {
...
?>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable" style="table-layout:fixed;">
					<tr>
						...
						<td nowrap class="tdhead_center" width="80">소속</td>
