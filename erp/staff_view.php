...
function getDocNo() {
	...
	var pay_gbn = "";
	if(f.pay_gbn[0].checked ){
		pay_gbn = "0";
	}else if( f.pay_gbn[1].checked ) {
		pay_gbn = "1";
	}else if( f.pay_gbn[2].checked ) {
		pay_gbn = "2";
	}else if( f.pay_gbn[3].checked ) {
		pay_gbn = "3";
	}
	if( pay_gbn == "" ){
...
function checkDocNo() {
	...
	var doc_no = getDocNo();
	if( doc_no == "" ){
		//f.pay_gbn[0].checked = false;
		//f.pay_gbn[1].checked = false;
		//f.pay_gbn[2].checked = false;
		//임시주석처리
		//alert("사업장에 일치하는 근로계약서가 없습니다. 다른 급여 유형을 선택해 주세요.");
	}
}
...
function setPayBase() {
	...
	if(frm.pay_gbn[0].checked || frm.pay_gbn[2].checked || frm.pay_gbn[3].checked){
		...
		frm.check_money_min_2013_yn.value = document.formSalary.check_money_min_2013_yn.checked ? "Y" : "N"; // 기본급 수동입력
...
function setWorkHour( type, base_gn ) {
	...
	if(document.formSalary.check_money_min_2013_yn.checked) {
		money_min_time = <?=$money_min_time_2013?>;
	} else {
...
?>
	...
	if( f.check_worktime_yn.checked ) { // 수동입력
		...
		//alert("소정근로시간(1개월) : "+workhour_day+" = ( "+workhour_day_ w+" + "+workhour_day_d_limit+" ) * "+month_calc);
...
function checkWorkTime_wYn() {
	if( !document.dataForm.pay_gbn[0].checked && !document.dataForm.pay_gbn[1].checked && !document.dataForm.pay_gbn[2].checked && !document.dataForm.pay_gbn[3].checked  ) {
		return;
	}
	var f;
					...
					<td onmouseover="showM('900')">
						<div style="margin:10px 20px 20px 20px;min-height:480px;">
							...
							<table width="910" border="0" align="left" cellpadding="0" cellspacing="0" >
								<tr>
									<td valign="top" style="padding:10px 0 18px 0">
										<!--탭메뉴 -->
...
?>
										...
										<div id="tab1">
											...
											<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" style="">
												...
												<tr>
													...
													<td nowrap class="tdrow" colspan="3">
														...
														<div style="float:;height:22px">
															<table border=0 cellpadding=0 cellspacing=0><tr><td width=2></td><td><img src=./images/btn2_lt.gif></td><td background=./images/btn2_bg.gif class=ftbutton3_white nowrap><a href="javascript:checkAddress('cust');" target="">주소찾기</a></td><td><img src=./images/btn2_rt.gif></td><td width=2></td></tr></table>
														</div>
												...
												<tr>
													...
													<td nowrap class="tdrow">
														총<input name="family_count" type="text" class="textfm" style="width:35px;ime-mode:disabled;" value="<?=$row2[family_cnt]?>" maxlength="4" onKeyPress="onlyNumber();">명
														자녀<input name="child_count" type="text" class="textfm" style="width:35px;ime-mode:disabled;" value="<?=$row2[child_cnt]?>" maxlength="4" onKeyPress="onlyNumber();">명
													</td>
												</tr>
												<tr>
													...
													<td nowrap class="tdrow">
														...
														<input type="radio" name="work_form" value="<?=$i?>" <? if($row1[work_form] == $i) echo "checked"; ?> onclick="" ><?=$work_form_txt[$i]?>
														<?
														}
														?>

													</td>
													<td nowrap class="tdrowk"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">적용보험<font color="red"></font></td>
													<td nowrap class="tdrow">
														<?
														//echo $row1[apply_gy];
												...
												<tr>
													...
													<td class="tdrow" rowspan="2">
														<input type="text" class="textfm" name="bank_2" value="<?=$row2[bank_account]?>" style="width:166px" /> <br>예) 1234-12-1234
													</td>
													...
													<td class="tdrow">
														<input size="20" type="text" class="textfm" name="dept" value="<?=$row2[dept_1]?>" />
													</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td nowrap class="tdrow">
														<input type="checkbox" name="insurance" value="1" class="checkbox" <?=$insurance_chk?>> 두루누리 사회보험
													</td>
												</tr>
												<tr>
										...
										<div id="tab2" style="display:none">
											...
											if($check_money_min_2013_yn == "Y") {
												$money_min_time_var = $money_min_time_2013;
											} else {
											...
											<input type="hidden" name="check_money_min_2013_yn" value="N"><!-- 최저시급(2013년) 수동 입력 -->
...
?>
														<input type="radio" name="pay_gbn" value="0" onclick="displayPayGbn();checkDocNo();" <? if($row2[pay_gbn] == "0") echo "checked"; ?> >월급제
														<input type="radio" name="pay_gbn" value="1" onclick="displayPayGbn();checkDocNo();" <? if($row2[pay_gbn] == "1") echo "checked"; ?> >시급제
														<input type="radio" name="pay_gbn" value="2" onclick="displayPayGbn();checkDocNo();" <? if($row2[pay_gbn] == "2") echo "checked"; ?> style="display:none"><!--복합근무-->
														<input type="radio" name="pay_gbn" value="3" onclick="displayPayGbn();checkDocNo();" <? if($row2[pay_gbn] == "3") echo "checked"; ?> >연봉제
													</td>
...
?>
										...
										<form name="formSalary" id="formSalary" style="margin:0display:;">
											...
											<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" style="table-layout:fixed">
												<tr>
													<td class="tdrowk_center">② 최저시급(2014년)</td>
													<td class="tdrow" valign="top">
														...
														<input type="checkbox" name="check_money_min_2013_yn" id="check_money_min_2013_yn" value="<?=$check_money_min_2013_yn?>" <? if($check_money_min_2013_yn == "Y") echo "checked"; ?> onClick="checkMoney_Min2013Yn('4,860')">4,860원(2013년)
													</td>
											...
											<table border=0 cellspacing=0 cellpadding=0 style="display:inline">
												<tr>
													<td id=""> 
														<input type="checkbox" name="check_money_b_yn" id="check_money_b_yn" value="Y" <? if($row4[check_money_b_yn] == "Y") echo "checked"; ?> onClick="checkMoney_bYn()">수동
													</td>
												</tr> 
											</table>
											<div style="height:2px;font-size:0px" class="bgtr"></div>
...
$money_e1 = number_format($row4[money_e1]);
$money_e2 = number_format($row4[money_e2]);
$money_e3 = number_format($row4[money_e3]);
$money_e4 = number_format($row4[money_e4]);
//echo $money_e4;
$money_e5 = number_format($row4[money_e5]);
$money_e6 = number_format($row4[money_e6]);
$money_e7 = number_format($row4[money_e7]);
$money_e8 = number_format($row4[money_e8]);
...
?>
											...
											<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" style="table-layout:fixed">
												<tr>
													...
													<td class="tdrow" valign="top">
														<input name="money_total_sum" type="text" class="textfm5" style="width:70;ime-mode:disabled;" value="0" maxlength="10" readonly> 원
													</td>
