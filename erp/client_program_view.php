			...
			<div style="margin:10px 20px 20px 20px;min-height:480px;">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td width="130"><a href="client_program_list.php"><img src="images/top18_01.gif" border="0" /></a></td>
						<td></td>
					</tr>
...
?>
											...
											<td nowrap  class="tdrow">
												...
												<a href="http://easynomu.com/easynomu/login_check_easynomu.php" onclick="easynomu_login(this.href);return false;" title="로그인"><img src="images/icon_login.png" border="0" style="vertical-align:middle;" /></a>
											</td>
										</tr>
										<tr>
...
if($member['mb_level'] != 6) {
	$url_save = "javascript:checkData('client_program_update.php');";
} else {
	$url_save = "javascript:alert_no_right();";
}
//목록 링크
$list_url = "./client_program_list.php?page=".$page."&amp;".$qstr."&amp;".$stx_qstr;
//본사 권한
if($member['mb_level'] >= 6) {
?>
