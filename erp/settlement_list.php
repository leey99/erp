...
$colspan = 15;
//검색 파라미터 전송
$qstr = "stx_comp_name=".$stx_comp_name."&stx_t_no=".$stx_t_no."&stx_biz_no=".$stx_biz_no."&stx_boss_name=".$stx_boss_name."&stx_comp_tel=".$stx_comp_tel."&stx_proxy=".$stx_proxy."&stx_comp_gubun1=".$stx_comp_gubun1."&stx_comp_gubun2=".$stx_comp_ubun2."&stx_comp_gubun3=".$stx_comp_gubun3."&stx_comp_gubun4=".$stx_comp_gubun4."&stx_comp_gubun5=".$stx_comp_gubun5."&stx_comp_gubun6=".$stx_comp_gubun6."&stx_man_cust_name=".$stx_man_cust_name."&stx_man_cust_name2=".$stx_man_cust_name2."&stx_uptae=".$stx_uptae."&stx_upjong=".$stx_upjong."&search_ok=".$search_ok;
$qstr .= "&search_year=".$search_year."&search_month=".$search_month."&search_year_end=".$search_year_end."&search_month_end=".$search_month_end."&stx_search_day_chk=".$stx_search_day_chk."&search_sday=".$search_sday."&search_eday=".$search_eday."&stx_application_kind=".$stx_application_kind;
			...
			<div style="margin:10px 20px 20px 20px;min-height:480px;">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td><img src="images/top03_01.gif" border="0" alt="결산현황" /></td>
						<td>
<?
$title_main_no = "03";
										...
										<td id=""> 
											<table border="0" cellpadding="0" cellspacing="0"> 
												<tr> 
													...
													<td background="images/g_tab_on_bg.gif" class="Sftbutton_white" style='width:80;text-align:center'>검색</td> 
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" style="table-layout:fixed">
									<tr>
										<td align="center">
											...
											<a href="settlement_report.php" target=""><img src="./images/btn_settlement_report_big.png" border="0"></a>
										</td>
									</tr>
								</table>
							</form>
							...
							<form name="dataForm" method="post">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable" style="">
									<tr>
										...
										<td class="tdhead_center" width="76" rowspan="">관리점</td>
										...
										<td class="tdhead_center" width="72" rowspan="">통장입금액</td>
										<td class="tdhead_center" width="72" rowspan="">본사수입</td>
										<td class="tdhead_center" width="76" rowspan="">본사입금액</td>
										<td class="tdhead_center" width="48" rowspan="">수당료</td>
										<td class="tdhead_center" width="73" rowspan="">용역비</td>
										<td class="tdhead_center" width="100" rowspan="">비고</td>
									</tr>
<?
// 리스트 출력
...
*/
	//본사수입 <- 청구금액 160502
	$main_income1 = number_format((int)$row['requested_amount'],0);
	if($main_income1 == 0) $main_income1 = "-";
	//본사수입 합계
	$mi  = $row['requested_amount'];
	$main_income_sum += ($mi);
	//수당료 / 용역비
	...
	if($member['mb_level'] > 6 || $row['damdang_code'] == $member['mb_profile'] || $row['damdang_code2'] == $member['mb_profile']) {
		$com_view = "settlement_view.php?id=$id&w=u&$qstr&page=$page";
	} else {
...
?>
									<tr>
										...
										<td class="tdhead_center"></td>
										<td class="tdhead_center" colspan="5">합계(업체입금액, 통장입금액, 본사수입, 김봉균수수료, 용역비)</td>
										<td class="tdhead_right"><?=number_format($client_receipt_fee_sum)?></td>
										<td class="tdhead_center"></td>
										<td class="tdhead_right"><?=number_format($requested_amount_sum)?></td>
										<td class="tdhead_right"><?=number_format($main_income_sum)?></td>
										<td class="tdhead_right"><?=number_format($main_receipt_fee_sum)?></td>
										<td class="tdhead_center"></td>
