...
function memo_del(id,idx,memo_type) {
	if(confirm("삭제하시겠습니까?")) {
		location.href = "popup_memo_delete.php?id="+id+"&idx="+idx+"&memo_type="+memo_type+"&dealer=ok";
	}
}
</script>
<?
//전기요금컨설팅 전달사항만 표시 / 전기 외 전력수요관리 추가로 memo_type 파라미터 받기 161010
//$memo_type = 11;
//덧글
...
<form name="dataForm" method="post" enctype="" style="margin:5px 0 0 0;height:84px;">
	...
	<input type="hidden" name="dealer" value="ok" />
