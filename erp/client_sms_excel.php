...
$cell = array("No","등록일자","사업장명","주소","사업자등록번호","사업장관리번호","사무위탁","대리인선임","전자민원","대표자HP","전화번호","팩스번호","이메일","대표자","사업개시일","업태","업종","관리점","담당자");

$now_date_file = date("Ymd");
$file_name = "문자메세지발송_".$now_date_file.".xls";
header("Pragma:");
