...
$top_sub_title = "images/top05_05.gif";
$sub_title = "피보험자신고";
...
if($w == "u") {
	...
	//피보험자신고 DB
	$sql_4insure = " select * from samu_4insure where idx='$idx' ";
	$result_4insure = sql_query($sql_4insure);
	$row_4insure = mysql_fetch_array($result_4insure);
}
//메모
$memo = $row['memo'];
//사무위탁수임
...
function checkData() {
	...
	frm.action = "samu_insure_update.php";
	frm.submit();
	return;
}
...
function del_com(page, idx) {
	if(confirm("삭제 하시겠습니까?")) {
		location.href = "samu_insure_delete.php?page="+page+"&idx="+idx;
	}
}
//]]>
</script>
...
$url_list = "./samu_insure_list.php?page=".$page."&".$qstr;
?>
		<td onmouseover="showM('900')" valign="top">
			<div style="margin:10px 20px 20px 20px;min-height:480px;">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td width="100"><img src="images/top05.gif" border="0" alt="사업분야" /></td>
						<td><a href="<?=$url_list?>"><img src="<?=$top_sub_title?>" border="0" alt="피보함자신고" /></a></td>
						<td></td>
					</tr>
											...
											<table border=0 cellpadding=0 cellspacing=0> 
												<tr> 
													...
													<td background="images/so_tab_on_bg.gif" class="Sftbutton_white" nowrap style='width:100px;text-align:center'> 
														<span onclick="" style="cursor:pointer">피보험자신고</span>
													</td> 
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" id="" style="">
									<tr>
										<td nowrap class="tdrowk" width="120">
											<img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">신고구분<font color="red">*</font>
										</td>
...
?>
												<option value="<?=$m?>" <? if($row_4insure['report_kind'] == $m) echo "selected"; ?> ><?=$report_kind_arry[$m]?></option>
<?
}
?>
										...
										<td nowrap class="tdrowk" width="120"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">보험구분</td>
										<td nowrap  class="tdrow" width="230">
											<input type="checkbox" name="isgy" value="1" <? if($row_4insure['isgy']) echo "checked"; ?> class="checkbox" style="vertical-align:middle;margin-bottom:4px;" />고용
											<input type="checkbox" name="issj" value="1" <? if($row_4insure['issj']) echo "checked"; ?> class="checkbox" style="vertical-align:middle;margin-bottom:4px;" />산재
											<input type="checkbox" name="iskm" value="1" <? if($row_4insure['iskm']) echo "checked"; ?> class="checkbox" style="vertical-align:middle;margin-bottom:4px;" />연금
											<input type="checkbox" name="isgg" value="1" <? if($row_4insure['isgg']) echo "checked"; ?> class="checkbox" style="vertical-align:middle;margin-bottom:4px;" />건강
										</td>
										<td nowrap class="tdrowk" width="120">
											<img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">등록일시
										</td>
										<td nowrap  class="tdrow">
											<input name="regdt" type="text" class="textfm" style="width:130px;" value="<?=$row_4insure['regdt']?>" maxlength="19" onclick="">
										</td>
									</tr>
									<tr>
										<td nowrap class="tdrowk"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">근로자명<font color="red">*</font></td>
										<td nowrap class="tdrow">
											<input name="staff_name" type="text" class="textfm" style="width:80px;ime-mode:active;" value="<?=$row_4insure['staff_name']?>" maxlength="14" />
										</td>
										<td class="tdrowk"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0" alt="*" />주민등록번호</td>
										<td class="tdrow">
											<input name="staff_ssnb" type="text" class="textfm" style="width:110px;ime-mode:disabled;" value="<?=$row_4insure['staff_ssnb']?>" maxlength="14" onkeydown="" onkeyup="checkhyphen_ssnb(this.value, this)" />
										</td>
										<td nowrap class="tdrowk">
											<img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">신고일자
										</td>
										<td nowrap  class="tdrow">
											<input name="report_date" type="text" class="textfm5" readonly style="width:70px;ime-mode:disabled;background:#f0f0f0;float:left;" value="<?=$row_4insure['report_date']?>" maxlength="10" onKeyPress="only_number_comma();" onkeyup="checkcomma(this.value, this,'Y')">
									...
									<tr>
										<td nowrap class="tdrowk">
											<img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">접수방법
										</td>
										<td nowrap  class="tdrow" colspan="5">
											<select name="input_type" class="selectfm">
												<option value="">선택</option>
												<option value="1" <? if($row_4insure['input_type'] == "1") echo "selected"; ?> >이지노무</option>
												<option value="2" <? if($row_4insure['input_type'] == "2") echo "selected"; ?> >키즈노무</option>
												<option value="3" <? if($row_4insure['input_type'] == "3") echo "selected"; ?> >기타</option>
											</select>
										</td>
									</tr>
									<tr>
										...
										<td nowrap  class="tdrow" colspan="5">
											<input name="staff_memo" type="text" class="textfm" style="width:99%;ime-mode:active;" value="<?=$row_4insure['staff_memo']?>" maxlength="30" />
										</td>
									</tr>
								</table>
