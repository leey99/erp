...
$sub_title = "본사";
$g4[title] = $sub_title." : 수당관리 : ".$easynomu_name;
					...
					<td onmouseover="showM('900')">
						<div style="margin:10px 20px 20px 20px;min-height:480px;">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td width="100"><img src="images/top04.gif" border="0"></td>
									<td width="129"><a href="allowance_list.php"><img src="images/menu04_top01_on.gif" border="0"></a></td>
									<td width="129"><a href="allowance_salesman.php"><img src="images/menu04_top02_off.gif" border="0"></a></td>
									<td width="129"><a href="allowance_branch.php"><img src="images/menu04_top03_off.gif" border="0"></a></td>
									<td width="129"><a href="allowance_dealer.php"><img src="images/menu04_top04_off.gif" border="0"></a></td>
									<td></td>
								</tr>
								<tr><td height="1" bgcolor="#cccccc" colspan="6"></td></tr>
							</table>
