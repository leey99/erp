...
/*
	if(frm.kepco_dsm_no.value == "") {
		alert("출원인번호는 필수값입니다.\n확인 후 등록 바랍니다.");
		frm.kepco_dsm_no.focus();
		return;
	}
*/
	frm.action = "kepco_dsm_update.php";
	frm.submit();
	return;
}
...
//이력
function kepco_dsm_history(id) {
	var ret = window.open("./kepco_dsm_history_popup.php?id="+id, "window_kepco_dsm_history", "scrollbars=yes,width=640,height=240");
	return;
}
//]]>
</script>
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" id="" style="">
									<tr>
										<td nowrap class="tdrowk" width="120">
											<img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">iSMART ID<font color="red"></font>
										</td>
										<td nowrap class="tdrow" width="180">
											<input name="kepco_dsm_no" type="text" class="textfm" style="width:110px;ime-mode:disabled;" value="<?=$row2['kepco_dsm_no']?>" maxlength="10" onkeydown="only_number()" />
										</td>
										<td nowrap class="tdrowk" width="120"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">iSMART PW</td>
										<td nowrap class="tdrow" width="180">
											<input name="kepco_dsm_pw" type="text" class="textfm" style="width:110px;ime-mode:disabled;" value="<?=$row2['kepco_dsm_pw']?>" maxlength="14" />
										</td>
										<td class="tdrowk" width="120"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0" alt="*" />처리현황</td>
										<td class="tdrow">
<?
$sel_check_ok = array();
...
?>
											<select name="kepco_dsm_process" class="selectfm" style="float:left;">
...
?>
											<table border="0" cellpadding="0" cellspacing="0" style="float:left;vertical-align:middle;margin-left:10px;"><tr><td width="2"></td><td><img src="images/btn_lt.gif"></td><td background="images/btn_bg.gif" class="ftbutton1" nowrap><a href="javascript:kepco_dsm_history('<?=$id?>');" target="">이력</a></td><td><img src="images/btn_rt.gif"></td><td width="2"></td></tr></table>
...
?>
									...
									<tr>
										<td nowrap class="tdrowk"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">계량기번호</td>
										<td nowrap class="tdrow">
											<input name="kepco_dsm_meter" type="text" class="textfm" style="width:110px;ime-mode:disabled;" value="<?=$row2['kepco_dsm_meter']?>" maxlength="11" onkeydown="only_number()" />
										</td>
										<td class="tdrowk"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0" alt="*" />계약기간</td>
										<td class="tdrow" colspan="3">
											<input name="kepco_dsm_start" type="text" class="textfm" style="width:80px;ime-mode:disabled;float:left;" value="<?=$row2['kepco_dsm_start']?>" maxlength="10" onkeydown="only_number();" onkeyup="checkcomma(this.value, this,'Y')">
											<table border="0" cellpadding="0" cellspacing="0" style="vertical-align:middle;float:left;"><tr><td width="2"></td><td><img src="./images/btn2_lt.gif"></td><td background="./images/btn2_bg.gif" class="ftbutton3_white" nowrap><a href="javascript:loadCalendar(document.dataForm.kepco_dsm_start);" target="">달력</a></td><td><img src="./images/btn2_rt.gif"></td> <td width="2"></td></tr></table>
											<div style="float:left;margin:0 5px 0 4px;">~</div>
											<input name="kepco_dsm_end" type="text" class="textfm" style="width:80px;ime-mode:disabled;float:left;" value="<?=$row2['kepco_dsm_end']?>" maxlength="10" onkeydown="only_number();" onkeyup="checkcomma(this.value, this,'Y')">
											<table border="0" cellpadding="0" cellspacing="0" style="vertical-align:middle;float:left;"><tr><td width="2"></td><td><img src="./images/btn2_lt.gif"></td><td background="./images/btn2_bg.gif" class="ftbutton3_white" nowrap><a href="javascript:loadCalendar(document.dataForm.kepco_dsm_end);" target="">달력</a></td><td><img src="./images/btn2_rt.gif"></td> <td width="2"></td></tr></table>
										</td>
									</tr>
									<tr>
										<td nowrap class="tdrowk"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">최종용량</td>
										<td nowrap class="tdrow">
											<input name="kepco_dsm_capacity" type="text" class="textfm" style="width:110px;ime-mode:disabled;" value="<?=$row2['kepco_dsm_capacity']?>" maxlength="11" onkeydown="only_number()" />
										</td>
										<td class="tdrowk"></td>
										<td class="tdrow" colspan="3">
										</td>
									...
									<tr>
										...
										<td nowrap  class="tdrow" colspan="5">
											<textarea name="kepco_dsm_memo" class="textfm" style='width:100%;height:76px;word-break:break-all;'><?=$row2['kepco_dsm_memo']?></textarea>
										</td>
									</tr>
								</table>
								<div style="height:10px;font-size:0px"></div>
								...
								<table border="0" cellspacing="0" cellpadding="0"> 
									<tr>
										<td> 
											<table border="0" cellpadding="0" cellspacing="0" onclick="var div_display='kepco_dsm_file_div';if(getId(div_display).style.display=='none') { getId(div_display).style.display='';} else { getId(div_display).style.display='none';}" style="cursor:pointer">
												<tr> 
...
if($member['mb_id'] == "kcmc1001") {
	if(!$row['kepco_dsm_file_1'] && !$row['kepco_dsm_file_2'] && !$row['kepco_dsm_file_3'] && !$row['kepco_dsm_file_4']) {
		$kepco_dsm_file_div_display = "display:none;";
	}
}
else $kepco_dsm_file_div_display = "";
?>
								<div id="kepco_dsm_file_div" style="<?=$kepco_dsm_file_div_display?>">
								<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" style="">
									<tr>
										<td class="tdrowk" width="120"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0" alt="*" />파일1 <? if($is_damdang == "ok") { ?><input type="checkbox" name="kepco_dsm_file_hidden_del_1" value="1" style="vertical-align:middle" />삭제<? } ?>
<?
if($is_damdang == "ok") {
?>
											<div style="margin:4px 0 0 0">
												<img src="./images/icon_blank.gif" width="2" height="2" style="margin:0 5px 3px 0" alt="*" /><a href="javascript:field_add('kepco_dsm_file_tr');"><img src="images/btn_add.png" border="0" style="vertical-align:middle" alt="+" /> <span  style="">추가</span></a>
											</div>
<?
}
if($row['kepco_dsm_file_1']) $kepco_dsm_file_1 = mb_substr($row['kepco_dsm_file_1'],16,99,'euc-kr');
if($row['kepco_dsm_file_2']) $kepco_dsm_file_2 = mb_substr($row['kepco_dsm_file_2'],16,99,'euc-kr');
if($row['kepco_dsm_file_3']) $kepco_dsm_file_3 = mb_substr($row['kepco_dsm_file_3'],16,99,'euc-kr');
if($row['kepco_dsm_file_4']) $kepco_dsm_file_4 = mb_substr($row['kepco_dsm_file_4'],16,99,'euc-kr');
?>
										</td>
										<td   class="tdrow" width="373">
											<? if($is_damdang == "ok") { ?><input name="kepco_dsm_file_1" type="file" class="textfm_search" style="width:250px;margin:0 0 4px 0;" /><br/><? } ?>
											<a href="files/kepco_dsm/<?=$row['kepco_dsm_file_1']?>" target="_blank"><?=$kepco_dsm_file_1?></a>
											<input type="hidden" name="kepco_dsm_file_hidden_1" value="<?=$row['kepco_dsm_file_1']?>" />
										</td>
										<td class="tdrowk" width="120"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0" alt="*" />파일2 <? if($is_damdang == "ok") { ?><input type="checkbox" name="kepco_dsm_file_hidden_del_2" value="1" style="vertical-align:middle" />삭제<? } ?></td>
										<td   class="tdrow" >
											<? if($is_damdang == "ok") { ?><input name="kepco_dsm_file_2" type="file" class="textfm_search" style="width:250px;margin:0 0 4px 0;" /><br/><? } ?>
											<a href="files/kepco_dsm/<?=$row['kepco_dsm_file_2']?>" target="_blank"><?=$kepco_dsm_file_2?></a>
											<input type="hidden" name="kepco_dsm_file_hidden_2" value="<?=$row['kepco_dsm_file_2']?>" />
										</td>
									</tr>
									<tr id="kepco_dsm_file_tr2" style="<? if(!$row['kepco_dsm_file_3'] && !$row['kepco_dsm_file_4']) echo "display:none"; ?>">
										<td class="tdrowk" width=""><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0" alt="*" />파일3 <? if($is_damdang == "ok") { ?><input type="checkbox" name="kepco_dsm_file_hidden_del_3" value="1" style="vertical-align:middle" />삭제<? } ?></td>
										<td   class="tdrow" >
											<? if($is_damdang == "ok") { ?><input name="kepco_dsm_file_3" type="file" class="textfm_search" style="width:250px;margin:0 0 4px 0;" /><br/><? } ?>
											<a href="files/kepco_dsm/<?=$row['kepco_dsm_file_3']?>" target="_blank"><?=$kepco_dsm_file_3?></a>
											<input type="hidden" name="kepco_dsm_file_hidden_3" value="<?=$row['kepco_dsm_file_3']?>" />
										</td>
										<td class="tdrowk" width=""><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0" alt="*" />파일4 <? if($is_damdang == "ok") { ?><input type="checkbox" name="kepco_dsm_file_hidden_del_4" value="1" style="vertical-align:middle" />삭제<? } ?></td>
										<td   class="tdrow" >
											<? if($is_damdang == "ok") { ?><input name="kepco_dsm_file_4" type="file" class="textfm_search" style="width:250px;margin:0 0 4px 0;" /><br/><? } ?>
											<a href="files/kepco_dsm/<?=$row['kepco_dsm_file_4']?>" target="_blank"><?=$kepco_dsm_file_4?></a>
											<input type="hidden" name="kepco_dsm_file_hidden_4" value="<?=$row['kepco_dsm_file_4']?>" />
										</td>
									</tr>
								</table>
								</div>
