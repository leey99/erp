...
if($easynomu_fname1) {
	$easynomu_fname_sql_1 = " file_easynomu_1 = '$upload_file_name', ";
} else {
...
if($easynomu_fname2) {
	$easynomu_fname_sql_2 = " file_easynomu_2 = '$upload_file_name', ";
} else {
...
$sql_common2_master = "
						...
						chk_contract_no = '$chk_contract_no',
...
if ($w == 'u'){
	$qstr = $_POST['qstr'];
	//exit;
	alert("정상적으로 거래처가 수정 되었습니다.","client_view.php?id=".$id."&w=".$w."&page=".$page."&".$qstr."&".$stx_qstr);
}else{
