...
$qstr .= "&search_day_all=".$search_day_all."&search_day1=".$search_day1."&search_day3=".$search_day3."&search_day4=".$search_day4."&search_day5=".$search_day5."&stx_biz_no_input_not=".$stx_biz_no_input_not."&stx_t_no_input_not=".$stx_t_no_input_not;
$qstr .= "&stx_addr=".$stx_addr."&stx_addr_first=".$stx_addr_first."&stx_manage_name=".$stx_manage_name."&stx_samu_state=".$stx_samu_state."&stx_levy_kind=".$stx_levy_kind."&stx_samu_state_total=".$stx_samu_state_total;
//메모
$memo = $row['memo'];
$memo1 = $row['memo1'];
$memo2 = $row['memo2'];
			...
			<div style="margin:10px 20px 20px 20px;min-height:480px;">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td width="130"><a href="samu_list.php"><img src="images/top05_01.gif" border="0" /></a></td>
						<td></td>
					</tr>
								...
								<div id="tab2" >
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" style="">
										<tr>
											...
											<td nowrap class="tdrow"  width="366">
<?
...
?>
												...
												<input name="samu_receive_date" type="text" class="textfm" style="width:80px;ime-mode:disabled;" value="<?=$row['samu_receive_date']?>" maxlength="10" onKeyPress="only_number_comma();" onkeyup="checkcomma(this.value, this,'Y')">
												번호 <input name="samu_receive_no" type="text" class="textfm" style="width:55px;ime-mode:disabled;" value="<?=$samu_receive_no?>" maxlength="5" onKeyPress="onlyNumber();">
												구번호 <input name="samu_receive_no_old" type="text" class="textfm" style="width:55px;ime-mode:disabled;" value="<?=$samu_receive_no_old?>" maxlength="4" onKeyPress="onlyNumber();">
											</td>
											<td nowrap class="tdrowk" width="110"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">사무위탁수임</td>
...
?>
												...
												수임
												<input name="samu_req_date" type="text" class="textfm" style="width:80px;ime-mode:disabled;" value="<?=$row['samu_req_date']?>" maxlength="10" onKeyPress="only_number_comma();" onkeyup="checkcomma(this.value, this,'Y')">
												해지
												<input name="samu_close_date" type="text" class="textfm" style="width:80px;ime-mode:disabled;" value="<?=$row['samu_close_date']?>" maxlength="10" onKeyPress="only_number_comma();" onkeyup="checkcomma(this.value, this,'Y')">
...
?>
												...
												<select name="samu_state_gy" class="selectfm" onchange="">
													...
													<option value="3" <? if($samu_state_gy == "3") echo "selected"; ?>>미가입</option>
												</select>
												산재
												<select name="samu_state_sj" class="selectfm" onchange="">
													...
													<option value="3" <? if($samu_state_sj == "3") echo "selected"; ?>>미가입</option>
												</select>
											</td>
...
?>
												<select name="levy_kind" class="selectfm" onchange="">
													...
													<option value="3" <? if($levy_kind == "3") echo "selected"; ?>>부과+자진</option>
												</select>
											</td>
...
?>
												...
												위임
												<input name="health_req_date" type="text" class="textfm" style="width:80px;ime-mode:disabled;" value="<?=$row['health_req_date']?>" maxlength="10" onKeyPress="only_number_comma();" onkeyup="checkcomma(this.value, this,'Y')">
												해지
												<input name="health_close_date" type="text" class="textfm" style="width:80px;ime-mode:disabled;" value="<?=$row['health_close_date']?>" maxlength="10" onKeyPress="only_number_comma();" onkeyup="checkcomma(this.value, this,'Y')">
											</td>
...
$sj_rate = $row['sj_rate'];
?>
												<input name="sj_rate" type="text" class="textfm" style="width:40px;ime-mode:disabled;" value="<?=$sj_rate?>" maxlength="4">%
											</td>
										</tr>
									</table>
									<div style="height:10px;font-size:0px;line-height:0px;"></div>
<?
include "inc/samu_4insure.php";
?>
									<!--댑메뉴 -->
									<a name="60001"></a>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" style="">
										<tr>
											<td nowrap class="tdrowk" width="110"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">통화일자</td>
											<td nowrap class="tdrow" width="366">
											...
											<td nowrap class="tdrowk" width="110"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">팩스전송결과</td>
...
?>
										...
										<tr>
											...
											<td nowrap  class="tdrow" colspan="3">
												<textarea name="samu_feedback_memo" class="textfm" style='width:100%;height:88px; word-break:break-all;' itemname="first_review_item" required><?=$row2['samu_feedback_memo']?></textarea>
											</td>
										</tr>
									</table>
									<div style="height:10px;font-size:0px;line-height:0px;"></div>
...
?>
										...
										<tr>
											<td nowrap class="tdrowk" width="110" style="padding-top:5px;padding-bottom:5px;"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">2015년도<br><img src="./images/blank.gif" width="7" height="2">보험료신고</td>
											<td nowrap class="tdrow" width="" colspan="">
<?
//보험료신고 DB
...
?>
										...
										<tr>
											<td nowrap class="tdrowk" style="padding-top:5px;padding-bottom:5px;"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0"><?=$total_insure_year?>년도<br><img src="./images/blank.gif" width="7" height="2">보험료신고</td>
...
if($row_total_insure['mail']) $total_insure_input[4] = "메일.";
else $total_insure_input[4] = "";
if($row_total_insure['report']) $total_insure_input[5] = "신고서";
else $total_insure_input[5] = "";
//접수여부
...
if($row_total_insure['input_date']) {
?>
												<b>　접수일</b> :
												<?=$row_total_insure['input_date']?>
<?
}
if($row_total_insure['ok_report']) {
?>
												<b>　신고현황</b> :
<?
	$total_insure_process_array = Array("","처리중","신고완료","자체신고","회계신고","현장신고","반려","기타");
	$total_insure_process_chk = $row_total_insure['ok_report'];
	echo $total_insure_process_array[$total_insure_process_chk];
}
if($row_total_insure['ok_date']) {
?>
												<b>　신고일</b> :
												<?=$row_total_insure['ok_date']?>
<?
}
?>
											</td>
...
?>
											...
											<td nowrap class="tdrow" width="" colspan="">
<?
$samu_keep_array = Array("","유지","해지예정","해지");
$samu_keep = $row['samu_keep'];
echo $samu_keep_array[$samu_keep];
if($row['samu_keep_date']) {
?>
												<b>해지일</b>
												<?=$row['samu_keep_date']?>
<?
...
?>
										...
										<tr>
											<td nowrap class="tdrowk" style="padding:3px 6px 0 6px;"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0"><?=$total_year?>년도<br><img src="./images/blank.gif" width="7" height="2">(고용/산재)</td>
											<td nowrap class="tdrow" colspan="">
<?
//보수총액신고 DB
...
?>
												<br>
<?
if($row_total['input_date']) {
?>
												<b>접수일</b> :
												<?=$row_total['input_date']?>
<?
}
//보수총액 신고현황 배열
$total_req_yn_array = Array("","안내완료(1차)","안내완료(2차)","처리중","신고완료","자체신고","반려","해지예정","해지완료");
$total_req_yn_code = $row_total['ok_report'];
if($total_req_yn_code) {
?>
												<b>　신고현황</b> :
<?
	echo $total_req_yn_array[$total_req_yn_code];
}
if($row_total['ok_date']) {
?>
												<b>　신고일</b> :
												<?=$row_total['ok_date']?>
<?
...
?>
											...
											<td nowrap class="tdrowk" width=""><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0"><?=$total_year?>년도<br><img src="./images/blank.gif" width="7" height="2">(건강)</td>
											<td nowrap class="tdrow" width="" colspan="">
<?
if($row_total['ok_report_gg']) {
?>
												<b>신고현황</b> :
<?
	$total_req_gg_code = $row_total['ok_report_gg'];
	echo $total_req_yn_array[$total_req_gg_code];
}
if($row_total['ok_date_gg']) {
?>
												<b>　신고일</b> :
												<?=$row_total['ok_date_gg']?>
<?
}
?>
											</td>
...
<? } ?>
												<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=images/btn_lt.gif></td><td background=images/btn_bg.gif class=ftbutton1 nowrap><a href="./samu_list.php?<?=$qstr?>&page=<?=$page?>" target="">목 록</a></td><td><img src=images/btn_rt.gif></td><td width=2></td></tr></table>
<?
if($w == "u") {
?>
												...
												<table border="0" cellpadding="0" cellspacing="0" style="display:inline;"><tr><td width="2"></td><td><img src="images/btn_lt.gif"></td><td background="images/btn_bg.gif" class="ftbutton1" nowrap><a href="./total_pay_view.php?w=<?=$w?>&id=<?=$id?>" target="">보수총액신고</a></td><td><img src=images/btn_rt.gif></td><td width="2"></td></tr></table>
<? } ?>
											</td>
										</tr>
									</table>
