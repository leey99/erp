...
<table border=0 cellspacing=0 cellpadding=0 style=""> 
	<tr>
		<td> 
			<div id='print_page'>
				<div>
					<img src="./files/agent/electronic_appeal_12709845550.jpg" width="700">
				</div>
<?
$pop_left = 229;
$pop_top  = 356;
?>
				...
				<div id="pop1" class="clsDrag" style="display:">
					<img src="images/electronic_appeal_img.png" width="392" align="top" alt="" border="0" align="absmiddle" style="border: 0;" /></a>
				</div>
			</div>
<script type="text/JavaScript">
function pagePrint(Obj) {  
  var W = 756;        //screen.availWidth;  
