...
for($i=0;$i<$total_count;$i++) {
	//시급 데이터 있을 경우 실행
	//if($_POST['money_time_'.$i]) {
	//절감액 데이터 있을 경우 실행 161104
	if($_POST['tax_exemption_'.$i]) {
		...
		//새로운 데이터 저장
		$sql = "insert si4n_nhis_pay_time set 
				$sql_common
