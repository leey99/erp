...
//급여대장
$sql_search = " where com_code='$com_code' and sabun='$id' and year = '$search_year' and month = '$search_month' ";
...
//근로자 성명
$sql_sabun = " select * from pibohum_base where com_code='$com_code' and sabun='$id' ";
$result_sabun = sql_query($sql_sabun);
$row_sabun = mysql_fetch_array($result_sabun);

$file_name = $com_name."_급여명세서_".$row_sabun['name']."_".$search_year."_".$search_month.".xls";
header("Pragma:");
