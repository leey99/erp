...
?>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable" style="table-layout:fixed;">
								...
								<tr class="list_row_now_wh" onMouseOver="this.className='list_row_over';" onMouseOut="this.className='list_row_now_wh';">
									...
									<td nowrap class="ltrow1_center_h34"><?=number_format($row_month[sum_money_month]/$pay_count)?></td>
									<td nowrap class="ltrow1_center_h34"><?=number_format($row_month[sum_total])?></td>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable" style="table-layout:fixed;">
								...
								<?
								$sql = " select * from pibohum_base_pay where com_code='$com_code' and year='$search_year' and month='$search_month' and w_date='$w_date_first' and w_time='$w_time_first' $sql_order limit $from_record, $rows ";
								$result = sql_query($sql);
								// 리스트 출력
