...
if($is_admin == "super") {
	...
	$sql_search = " where com_code='$com_code' and year='$search_year' and pay_gbn='4' ";
}
// 검색 : 년
if ($search_year) {
	$sql_search .= " and ( ";
								...
								for ($i=0; $row_month=sql_fetch_array($result_month); $i++) {
									...
									if($year != $old_year || $month != $old_month || $i == 0) {
										...
										if($member['mb_profile'] == "guest") {
											...
											$url_form = "pay_stubs_all.php?code=$code&search_year=$search_year&search_month=$search_month&page=$page";
