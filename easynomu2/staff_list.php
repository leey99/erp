...
?>
									...
									<td nowrap class="tdhead_center" width="58"><?=$picture_text?></td>
...
?>
										<a href="<?=$staff_url?>"><img src="<?=$pic?>" width="50" height="50" alt="증명사진" style="border:solid 1px #dfdfdf;" /></a>
<?
}
?>
									</td>
...
if($member['mb_profile'] == "guest") {
	...
	$url_view = "staff_view.php?code=$com_code";
...
<?
//주품디자인 사원정보/급여정보 엑셀업로드 기능 160819
if($com_code == 20695) {
	$url_excel_save = "staff_excel_save.php?code=".$com_code;
...
function excel_upload(obj) {
	...
	frm.action = "staff_excel_upload.php";
	frm.submit();
	return;
}
//]]>
