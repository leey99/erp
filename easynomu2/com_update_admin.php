...
if ($w == 'u'){
	...
	sql_query($sql3);
	alert("정상적으로 사업장 기본정보가 수정 되었습니다.","com_view_admin.php?id=$id&w=$w&page=$page");
//등록
}else{
  ...
  //$id = mysql_insert_id();
	...
	alert("정상적으로 사업장 기본정보가 등록 되었습니다.","com_list_admin.php?page=$page");
}
?>