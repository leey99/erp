...
$sql = " select com_code, sabun, year, month, count(distinct sabun) as cnt, sum(money_total) as sum_total, sum(money_gongje) as sum_gongje, sum(money_result) as sum_result, w_date, w_time, dept_code
          $sql_common
          $sql_search $sql_group
          $sql_order 
