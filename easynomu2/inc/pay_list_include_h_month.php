...
function pay_step_btn(no) {
	for(i=1;i<=6;i++) {
		getId("pay_step"+i).src = "images/pay_step"+i+"_h_month.gif";
	}
	getId("pay_step"+no).src = "images/pay_step"+no+"_h_month_on.gif";
}
$(function(){
	...
	$('#step6').click(function() { 
		$('#spanTop').scrollLeft(3550);
		$('#spanMain').scrollLeft(3550);
		pay_step_btn(6);
	});
});
</script>
							...
							<form name="dataForm" method="post">
								...
								<table border=0 cellspacing=0 cellpadding=0> 
									<tr> 
										...
										<td width="6"></td> 
										<td width="" align="left">
											<div id="step1" style="cursor:pointer;margin:0 5px 0 0"><img src="images/pay_step1_h_month_on.gif" id="pay_step1"></div>
										</td> 
										<td width="" align="left">
											<div id="step2" style="cursor:pointer;margin:0 5px 0 0"><img src="images/pay_step2_h_month.gif" id="pay_step2"></div>
										</td> 
										<td width="" align="left">
											<div id="step3" style="cursor:pointer;margin:0 5px 0 0"><img src="images/pay_step3_h_month.gif" id="pay_step3"></div>
										</td> 
										<td width="" align="left">
											<div id="step4" style="cursor:pointer;margin:0 5px 0 0"><img src="images/pay_step4_h_month.gif" id="pay_step4"></div>
										</td>
										<td width="" align="left">
											<div id="step5" style="cursor:pointer;margin:0 5px 0 0"><img src="images/pay_step5_h_month.gif" id="pay_step5"></div>
										</td>
										<td width="" align="left">
											<div id="step6" style="cursor:pointer;margin:0 6px 0 0"><img src="images/pay_step6_h_month.gif" id="pay_step6"></div>
										</td>
