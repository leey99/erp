		...
		<div class="quick">
			<div style="width:137px;height:297px;background:url('./images/quick_bg.gif') no-repeat;">
				<div style="padding:84px 0 0 8px;" id="quick_link">
					...
					<span><a href="./staff_list.php">사원정보(사원관리)</a></span>
					<span><a href="./attendance.php">근태등록(근태관리)</a></span>
					<span><a href="./pay_month_list.php">급여계산(급여관리)</a></span>
			...
			<div style="margin:10px 0 0 0;background:url('./images/cal_bg.gif') no-repeat;width:136px;height:161px;">
				...
				<div style="padding:0 0 0 0;"><a href="./calculator/s2.html" onmouseover='cal2.src="./images/cal_02_on.gif";' onmouseout='cal2.src="./images/cal_02_off.gif";' onclick="cal_open(this.href,'s2',960,831);return false;"><img src="./images/cal_02_off.gif" border="0" name="cal2" id="cal2"></a></div>
				...
				<!--<div style="padding:0 0 0 0;"><a href="http://www.4insure.or.kr/ins4/ptl/data/calc/InsuFeeMockCalcLayout.do" target="_blank" onmouseover='cal4.src="./images/cal_04_on.gif";' onmouseout='cal4.src="./images/cal_04_off.gif";' onclick=""><img src="./images/cal_04_off.gif" border="0" name="cal4" id="cal4"></a></div>-->
