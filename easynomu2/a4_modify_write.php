...
$sub_title = "월평균보수변경신고";
$g4[title] = $sub_title." : 월보수변경신고 : ".$member['mb_nick'];
?>
<html>
<head>
...
?>
									...
									function modify_plus(n){
										//alert(n);
										if(frm.modify_count.value > 2000) {
...
if($row1['conduct'] == "2") $save_url = "javascript:alert('처리완료된 접수 건은 수정이 불가능합니다.');";
else $save_url = "javascript:checkData();";
?>
											<table border="0" cellpadding="0" cellspacing="0" style="display:inline;">
												<tr>
													<td width=2></td>
													<td><img src=images/btn_lt.gif></td>
													<td background=images/btn_bg.gif class=ftbutton1 nowrap><a href="<?=$save_url?>">저 장</a></td>
													<td><img src=images/btn_rt.gif></td>
												 <td width=2></td>
												</tr>
											</table>
