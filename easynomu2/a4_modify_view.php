...
?>
	...
	self.location.href = "a4_modify_list_admin.php?page=<?=$page?>";
<?
}
?>
</script>
...
?>
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" class="bgtable1_view" style="">
									<tr>
										<td class="td_center" width="40">번호</td>
...
if($member['mb_profile'] == "guest") {
	...
	if($conduct == 2) $url_modify = "javascript:alert('처리완료된 접수 건은 수정이 불가능합니다.');";
	else $url_modify = "a4_modify_write.php?w=u&id=".$row1['id']."".$qstr;
}
?>
