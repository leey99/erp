	...
	if(cnt==0) {
	 ...
	 return;
		...
		if(confirm("정말 삭제하시겠습니까?")) {
			...
			frm.action="staff_delete.php?kind=beistand";
			frm.submit();
		} else {
			return;
		}
							...
							<form name="searchForm" method="get">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1">
									<tr>
										...
										<td nowrap class="tdrowk">퇴사일</td>
										<td nowrap class="tdrow">
											<input type="checkbox" name="stx_out_day_chk" value="1" style="vertical-align:middle;" />입력
										</td>
									</tr>
								</table>
								<div style="width:100%;text-align:center;margin:10px 0 0 0;">
									<table border="0" cellpadding="0" cellspacing="0" style="height:18px;" align="center"><tr><td width=2></td><td><img src="images/btn9_lt.gif" /></td><td style="background:url(images/btn9_bg.gif) repeat-x center" class="ftbutton5_white" nowrap><a href="javascript:goSearch();" target="">검 색</a></td><td><img src="images/btn9_rt.gif" /></td><td width="2"></td></tr></table>
								</div>
							</form>
...
?>
									...
									<td nowrap class="tdhead_center" width="78">월보수변경</td>
<?
if($is_admin != "super") {
?>
...
for ($i=0; $row=sql_fetch_array($result); $i++) {
  ...
  $list = $i%2;
	...
	//근로계약서 -> 변경신고
	$work_contract = "<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=images/btn_lt.gif></td><td background=images/btn_bg.gif class=ftbutton1 nowrap><a href='$url_pay_modify' target=''>변경신고</a></td><td><img src=images/btn_rt.gif></td><td width=2></td></tr></table>";
	//증명사진
	if($row[pic]) {
...
if($member['mb_profile'] == "guest") {
	...
	$url_del = "javascript:delete_ok();";
	$url_view = "staff_view.php?kind=beistand&code=".$code."&page=".$page;
	$url_print = "javascript:alert('준비중입니다.');";
	$url_excel = "staff_excel_beistand.php?".$qstr;
}
?>
