...
function focusOutClass(idx) {
	...
	if(frm.idx[idx].checked == false) {
		...
		frm.workhour_total[idx].className = "textfm";
		...
		frm.money_total[idx].className = "textfm";
...
$check_c_manual_4insure = "checked";
														...
														<td>  
															<table width="<?=$pay_list_width?>" border="0" cellpadding="0" cellspacing="1" class="bgtable">
																...
																<tr>
																	...
																	<td class="tdhead_center" rowspan="1" width="56">국민연금<br /><input type="checkbox" name="manual_yun" <?=$check_manual_yun?> value="1" title="수동입력" style="vertical-align:middle;"></td>
...
?>
														...
														<td nowrap class="ltrow1_center_h24" width="63"><input type="text" style="width:100%;ime-mode:disabled;" onKeyPress="" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="workhour_total" value="<?=$workhour_total?>" onkeydown="if(event.keyCode == 13){ getId('id_workhour_total_<?=$k_next?>').focus(); }" id="id_workhour_total_<?=$k?>" /></td><!--임금산출 총시간-->
...
?>
														...
														<td nowrap class="ltrow1_center_h24" width="67"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_total" value="<?=number_format($row4['money_total'])?>" id="id_money_total_<?=$k?>" onkeyup="checkThousand(this.value, this,'Y');cal_pay('<?=$k?>');" onkeydown="if(event.keyCode == 13){ getId('id_money_total_<?=$k_next?>').focus(); }" /></td><!--서비스이용금액-->
														<td nowrap class="ltrow1_center_h24" width="67"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_for_tax" value="<?=number_format($row4['money_for_tax'])?>" id="id_money_for_tax_<?=$k?>" onkeyup="checkThousand(this.value, this,'Y');cal_pay('<?=$k?>');" onkeydown="if(event.keyCode == 13){ getId('id_money_for_tax_<?=$k_next?>').focus(); }" /></td><!--급여-->
