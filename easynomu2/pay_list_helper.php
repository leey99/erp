...
function goInput(mode){
	...
	f.mode.value = mode;
	f.action = "pay_update_type_helper.php";
	f.submit();
}
//급여반영 입력폼
...
function cal_pay2(idx){
	...
	var money_g1,money_g2,money_g3,money_g4,money_g5;
...
//기본급 고정
$sql_money_month = " select * from pibohum_base_pay_helper where com_code='$com_code' and year = '$search_year' and month = '$search_month' and w_date != '0000-00-00' order by w_date desc, w_time desc ";
														...
														<td>  
															<table width="<?=$pay_list_width?>" border="0" cellpadding="0" cellspacing="1" class="bgtable">
																...
																<tr>
																	...
																	<td class="tdhead_center" rowspan="1" width="56">국민연금</td>
																	...
																	<td class="tdhead_center" rowspan="1" width="98">국민연금</td>
...
?>
														...
														<td nowrap class="ltrow1_center_h24" width="63">
															<input type="text" style="width:100%;ime-mode:disabled;" onKeyPress="onlyNumber2();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="workhour_1" value="<?=$workhour_1?>" onKeyUp="cal_pay('<?=$k?>');"><!--보건복지 평근-->
														...
														<td nowrap class="ltrow1_center_h24" width="63">
															<input type="text" style="width:100%;ime-mode:disabled;" onKeyPress="onlyNumber2();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="workhour_1_hday" value="<?=$workhour_1_hday?>" onKeyUp="cal_pay('<?=$k?>');"><!--보건복지 휴심-->
														</td>
														<td nowrap class="ltrow1_center_h24" width="63">
															<input type="text" style="width:100%;ime-mode:disabled;" onKeyPress="onlyNumber2();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="workhour_2" value="<?=$workhour_2?>" onKeyUp="cal_pay('<?=$k?>');"><!--경기도 평근-->
														</td>
														<td nowrap class="ltrow1_center_h24" width="63">
															<input type="text" style="width:100%;ime-mode:disabled;" onKeyPress="onlyNumber2();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="workhour_2_hday" value="<?=$workhour_2_hday?>" onKeyUp="cal_pay('<?=$k?>');"><!--경기도 휴심-->
														</td>
														<td nowrap class="ltrow1_center_h24" width="63">
															<input type="text" style="width:100%;ime-mode:disabled;" onKeyPress="onlyNumber2();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="workhour_3" value="<?=$workhour_3?>" onKeyUp="cal_pay('<?=$k?>');"><!--화성시 평근-->
														</td>
														<td nowrap class="ltrow1_center_h24" width="63">
															<input type="text" style="width:100%;ime-mode:disabled;" onKeyPress="onlyNumber2();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="workhour_3_hday" value="<?=$workhour_3_hday?>" onKeyUp="cal_pay('<?=$k?>');"><!--화성시 휴심-->
														</td>
														<td nowrap class="ltrow1_center_h24" width="63">
															<input type="text" style="width:100%;ime-mode:disabled;" onKeyPress="onlyNumber2();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="workhour_edu" value="<?=$workhour_edu?>" onKeyUp="cal_pay('<?=$k?>');"><!--교육시간-->
														</td>
														<td nowrap class="ltrow1_center_h24" width="64">
															<input type="text" style="width:100%;ime-mode:disabled;" onKeyPress="onlyNumber2();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="workhour_phone" value="<?=$workhour_phone?>" onKeyUp="cal_pay('<?=$k?>');"><!--스마트폰-->
														</td>
														<td nowrap class="ltrow1_center_h24" width="65"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm"  name="money_year" value="<?=$annual_paid_holiday?>" onKeyUp="checkThousand(this.value, this,'Y');cal_pay('<?=$k?>');" /></td><!--교통지원금-->
...
?>
														...
														<td nowrap class="ltrow1_center_h24" width="98"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="c_money_yun" value="<?=number_format($row4[c_yun])?>" onKeyUp="checkThousand(this.value, this,'Y');cal_pay2('<?=$k?>');" /></td><!--국민연금-->
														<td nowrap class="ltrow1_center_h24" width="98"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="c_money_health" value="<?=number_format($row4[c_health])?>" onKeyUp="checkThousand(this.value, this,'Y');cal_pay2('<?=$k?>');" /></td><!--건강보험-->
														<td nowrap class="ltrow1_center_h24" width="98"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="c_money_yoyang" value="<?=number_format($row4[c_yoyang])?>" onKeyUp="checkThousand(this.value, this,'Y');cal_pay2('<?=$k?>');" /></td><!--장기요양보험-->
														<td nowrap class="ltrow1_center_h24" width="97"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="c_money_goyong" value="<?=number_format($row4[c_goyong])?>" onKeyUp="checkThousand(this.value, this,'Y');cal_pay2('<?=$k?>');" /></td><!--고용보험-->
														<td nowrap class="ltrow1_center_h24" width="97"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="c_money_sanjae" value="<?=number_format($row4[c_sanjae])?>" onKeyUp="checkThousand(this.value, this,'Y');cal_pay2('<?=$k?>');" /></td><!--산재보험-->
...
?>
	...
	money_total = parseInt( (workhour_1*<?=$money_time1_com?>) + (workhour_2*<?=$money_time2_com?>) + (workhour_3*<?=$money_time3_com?>) + (workhour_1_hday*<?=$money_time1_hday_com?>) + (workhour_2_hday*<?=$money_time2_hday_com?>) + (workhour_3_hday*<?=$money_time3_hday_com?>) );
...
<? } ?>
	...
	f.c_money_gongje[idx].value = c_money_gongje //money_gongje 공제계(사업장)
