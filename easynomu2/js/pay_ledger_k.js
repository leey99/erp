...
function OnStart(){
	...
	if(pay_page > 1) {
		//36명일 경우 4페이지 36명 급여대장 호출 161206
		if(pay_count == 36) pay_table = 'pay_ledger_k_'+pay_page+'page_'+pay_count+'.hwp';
		else pay_table = 'pay_ledger_k_'+pay_page+'page.hwp';
	}
	else pay_table = 'pay_ledger_k.hwp';
