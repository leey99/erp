...
function OnStart(){
	...
	if(!pHwpCtrl.Open(BasePath + "/files/docs/"+pay_table)){
		...
		if (pHwpCtrl.MoveToField("[성명]", true, true, false)){set.SetItem("Text",frm.pay_name.value);act.Execute(set);}
		...
		if (pHwpCtrl.MoveToField("[기본시급]", true, true, false)){set.SetItem("Text",frm.money_min_base.value);act.Execute(set);}
		...
		if (pHwpCtrl.MoveToField("법정1", true, true, false)){set.SetItem("Text",frm.b1_text.value);act.Execute(set);}
		if (pHwpCtrl.MoveToField("법정2", true, true, false)){set.SetItem("Text",frm.b2_text.value);act.Execute(set);}
		if (pHwpCtrl.MoveToField("법정3", true, true, false)){set.SetItem("Text",frm.b3_text.value);act.Execute(set);}
		if (pHwpCtrl.MoveToField("법정4", true, true, false)){set.SetItem("Text",frm.b4_text.value);act.Execute(set);}
