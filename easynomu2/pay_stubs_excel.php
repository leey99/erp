...
//급여대장
$sql_search = " where com_code='$com_code' and year = '$search_year' and month = '$search_month' and sabun='$id' ";
...
$file_name = $row['name']."_급여명세서_".$search_year."_".$search_month.".xls";
header("Pragma:");
...
<table border="1" cellspacing="1" cellpadding="3">
	...
	<tr>
		...
		<td align="center"><?=iconv("EUC-KR", "UTF-8", "원")?></td>
		<td align="center"><?=iconv("EUC-KR", "UTF-8", "소계")?></td>
		<td align="center"><?=number_format($g_sum)?></td>
		<td align="center"><?=iconv("EUC-KR", "UTF-8", "원")?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td align="center"><?=iconv("EUC-KR", "UTF-8", "원")?></td>
		<td align="center"><?=iconv("EUC-KR", "UTF-8", "소계")?></td>
		<td align="center"><?=number_format($s_sum)?></td>
		<td align="center"><?=iconv("EUC-KR", "UTF-8", "원")?></td>
	</tr>
	<tr>
	...
	<tr>
		<td align="center" rowspan="2" ><?=iconv("EUC-KR", "UTF-8", "기타<br />(과세)")?></td>
	...
	<tr>
		...
		<td align="center"><?=iconv("EUC-KR", "UTF-8", "가불")?></td>
