...
//법정수당 수동입력 (사원관리-급여정보) 연장근로 수동입력 140610
	if(!f.manual_ext.checked) {
		if(f.check_money_b_yn[idx].value == "Y") money_ext = parseInt(f.money_b2[idx].value);
														...
														<td>  
															<table width="<?=$pay_list_width?>" border="0" cellpadding="0" cellspacing="1" class="bgtable" style="table-layout:;">
																...
																<tr>
																	...
																	<td class="tdhead_center" rowspan="2" width="67">국민연금</td>
																	<td class="tdhead_center" rowspan="2" width="67">건강보험</td>
																	<td class="tdhead_center" rowspan="2" width="67">장기요양</td>
																	<td class="tdhead_center" rowspan="2" width="67">고용보험</td>
																	<td class="tdhead_center" rowspan="2" width="67">소득세</td>
																	<td class="tdhead_center" rowspan="2" width="67">주민세</td>
																</tr>
																<tr>
...
?>
														...
														<td nowrap class="ltrow1_center_h24" width="66"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_yun" value="<?=number_format($row4[yun])?>" onKeyUp="checkThousand(this.value, this,'Y');cal_pay2('<?=$k?>');"></td><!-- 국민연금 -->
														<td nowrap class="ltrow1_center_h24" width="66"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_health" value="<?=number_format($row4[health])?>" onKeyUp="checkThousand(this.value, this,'Y');cal_pay2('<?=$k?>');"></td><!-- 건강보험 -->
														<td nowrap class="ltrow1_center_h24" width="66"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_yoyang" value="<?=number_format($row4[yoyang])?>" onKeyUp="checkThousand(this.value, this,'Y');cal_pay2('<?=$k?>');"></td><!-- 장기요양보험 -->
														<td nowrap class="ltrow1_center_h24" width="66"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_goyong" value="<?=number_format($row4[goyong])?>" onKeyUp="checkThousand(this.value, this,'Y');cal_pay2('<?=$k?>');"></td><!-- 고용보험 -->
														...
														<td nowrap class="ltrow1_center_h24" width="72"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm5" readonly name="money_gongje" value="<?=number_format($row4[money_gongje])?>"></td><!-- 공제계 -->
