...
*/
				...
				//토요일 무급휴무일 설정시 연장근로시간 추가
				if(i == 5) {
					if ( workday_gbn == "04" ){ // 근무일, 무급근로
						for( var j=0; j < ext_hour_arr.length; j++ ){
							var tmp = work_hour_arr[j] - rest_hour_arr[j]- rest2_hour_arr[j]- rest3_hour_arr[j];
							if( tmp > 0 ) workhour_ext += tmp;
						}
					...
					<td>
						* 기본설정
						<select name="work_gbn_base" class="selectfm">
							<option value="A" <? if($row_opt2[work_gbn_base] == "A" || !$row_opt2[work_gbn_base]) echo "selected"; ?> >A형</option>
							<option value="B" <? if($row_opt2[work_gbn_base] == "B") echo "selected"; ?> >B형</option>
							<option value="C" <? if($row_opt2[work_gbn_base] == "C") echo "selected"; ?> >C형</option>
						</select>
					</td>
				</tr>
			</table>
...
?>
				...
				<tr>
					<td class="tdhead_center" rowspan="2">
						휴게시간
						<table border=0 cellpadding=0 cellspacing=0 style="" align="center"><tr><td width=2></td><td><img src=./images/btn1_lt.gif></td><td background=./images/btn1_bg.gif class=ftbutton3_white nowrap><a href="javascript:rest_add('A');" target="">추가</a></td><td><img src=./images/btn1_rt.gif></td><td width=2></td></tr></table>
					</td>
					<td class="tdhead_center">시작</td>
<?
for($i=0;$i<5;$i++) {
...
?>
				...
				<tr id="rest_str2" style="display:none">
					<td class="tdhead_center" rowspan="2">
						휴게시간2
						<table border=0 cellpadding=0 cellspacing=0 style="" id="rest_del_bt2" align="center"><tr><td width=2></td><td><img src=./images/btn1_lt.gif></td><td background=./images/btn1_bg.gif class=ftbutton3_white nowrap><a href="javascript:rest_del2('A');" target="">삭제</a></td><td><img src=./images/btn1_rt.gif></td><td width=2></td></tr></table>
					</td>
					<td class="tdhead_center">시작</td>
<?
for($i=0;$i<5;$i++) {
...
?>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" style="table-layout:fixed">
				<tr>
					...
					<td class="tdhead_center">1일 법정근로시간</td>
				...
				<tr>
					...
					<td class="tdrow_center">
						...
						<input type="checkbox" name="manual_day_a" <?=$check_manual_day?> onclick="check_manual(this, 'a');" value="1" style="vertical-align:middle;" />수동
					</td>
					<td class="tdrow_center">
						...
						<input type="checkbox" name="manual_ext_a" <?=$check_manual_ext?> onclick="check_manual(this, 'a');" value="1" style="vertical-align:middle;" />수동
					</td>
					<td class="tdrow_center">
						...
						<input type="checkbox" name="manual_night_a" <?=$check_manual_night?> onclick="check_manual(this, 'a');" value="1" style="vertical-align:middle;" />수동
					</td>
					<td class="tdrow_center">
						...
						<input type="checkbox" name="manual_hday_a" <?=$check_manual_hday?> onclick="check_manual(this, 'a');" value="1" style="vertical-align:middle;" />수동
					</td>
				</tr>
			</table>
		</div>
...
?>
				<tr>
					<td class="tdhead_center" rowspan="2">
						휴게시간
						<table border=0 cellpadding=0 cellspacing=0 style="" align="center"><tr><td width=2></td><td><img src=./images/btn1_lt.gif></td><td background=./images/btn1_bg.gif class=ftbutton3_white nowrap><a href="javascript:rest_add('B');" target="">추가</a></td><td><img src=./images/btn1_rt.gif></td><td width=2></td></tr></table>
					</td>
					<td class="tdhead_center">시작</td>
<?
for($i=0;$i<7;$i++) {
...
?>
				<tr id="rest_str2b" style="<? if($rest_shour2[0] == "") echo "display:none"; ?>">
					<td class="tdhead_center" rowspan="2">
						휴게시간2
						<table border=0 cellpadding=0 cellspacing=0 style="" align="center" id="rest_del_bt2b"><tr><td width=2></td><td><img src=./images/btn1_lt.gif></td><td background=./images/btn1_bg.gif class=ftbutton3_white nowrap><a href="javascript:rest_del2('B');" target="">삭제</a></td><td><img src=./images/btn1_rt.gif></td><td width=2></td></tr></table>
					</td>
					<td class="tdhead_center">시작</td>
<?
for($i=0;$i<7;$i++) {
...
?>
				<tr id="rest_str3b" style="<? if($rest_shour3[0] == "") echo "display:none"; ?>">
					<td class="tdhead_center" rowspan="2">
						휴게시간3
						<table border=0 cellpadding=0 cellspacing=0 style="" align="center" id="rest_del_bt3b"><tr><td width=2></td><td><img src=./images/btn1_lt.gif></td><td background=./images/btn1_bg.gif class=ftbutton3_white nowrap><a href="javascript:rest_del3('B');" target="">삭제</a></td><td><img src=./images/btn1_rt.gif></td><td width=2></td></tr></table>
					</td>
					<td class="tdhead_center">시작</td>
<?
for($i=0;$i<7;$i++) {
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" style="table-layout:fixed">
				...
				<tr>
					...
					<td class="tdrow_center">
						...
						<input type="checkbox" name="manual_day_b" <?=$check_manual_day_b?> onclick="check_manual(this, 'b');" value="1" style="vertical-align:middle;" />수동
					</td>
					<td class="tdrow_center">
						...
						<input type="checkbox" name="manual_ext_b" <?=$check_manual_ext_b?> onclick="check_manual(this, 'b');" value="1" style="vertical-align:middle;" />수동
					</td>
					<td class="tdrow_center">
						...
						<input type="checkbox" name="manual_night_b" <?=$check_manual_night_b?> onclick="check_manual(this, 'b');" value="1" style="vertical-align:middle;" />수동
					</td>
					<td class="tdrow_center">
						...
						<input type="checkbox" name="manual_hday_b" <?=$check_manual_hday_b?> onclick="check_manual(this, 'b');" value="1" style="vertical-align:middle;" />수동
					</td>
				</tr>
			</table>
		</div>
...
if($i == 0) {
?>
						<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=./images/btn1_lt.gif></td><td background=./images/btn1_bg.gif class=ftbutton3_white nowrap><a href="javascript:worktime_sdate_copy('<?=$work_gbn_chk?>');" target="">복사</a></td><td><img src=./images/btn1_rt.gif></td><td width=2></td></tr></table>
<?
}
?>
					</td>
...
if($i == 0) {
?>
						<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=./images/btn1_lt.gif></td><td background=./images/btn1_bg.gif class=ftbutton3_white nowrap><a href="javascript:worktime_edate_copy('<?=$work_gbn_chk?>');" target="">복사</a></td><td><img src=./images/btn1_rt.gif></td><td width=2></td></tr></table>
<?
}
?>
					</td>
...
?>
				<tr>
					<td class="tdhead_center" rowspan="2">
						휴게시간
						<table border=0 cellpadding=0 cellspacing=0 style="" align="center"><tr><td width=2></td><td><img src=./images/btn1_lt.gif></td><td background=./images/btn1_bg.gif class=ftbutton3_white nowrap><a href="javascript:rest_add('<?=$work_gbn_chk?>');" target="">추가</a></td><td><img src=./images/btn1_rt.gif></td><td width=2></td></tr></table>
					</td>
					<td class="tdhead_center">시작</td>
<?
for($i=0;$i<7;$i++) {
...
if($i == 0) {
?>
						<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=./images/btn1_lt.gif></td><td background=./images/btn1_bg.gif class=ftbutton3_white nowrap><a href="javascript:resttime_sdate_copy('<?=$work_gbn_chk?>');" target="">복사</a></td><td><img src=./images/btn1_rt.gif></td><td width=2></td></tr></table>
<?
}
?>
					</td>
...
if($i == 0) {
?>
						<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=./images/btn1_lt.gif></td><td background=./images/btn1_bg.gif class=ftbutton3_white nowrap><a href="javascript:resttime_edate_copy('<?=$work_gbn_chk?>');" target="">복사</a></td><td><img src=./images/btn1_rt.gif></td><td width=2></td></tr></table>
<?
}
?>
					</td>
...
?>
				<tr id="rest_str2c" style="<? if($rest_shour2[0] == "") echo "display:none"; ?>">
					<td class="tdhead_center" rowspan="2">
						휴게시간2
						<table border=0 cellpadding=0 cellspacing=0 style="" align="center" id="rest_del_bt2c"><tr><td width=2></td><td><img src=./images/btn1_lt.gif></td><td background=./images/btn1_bg.gif class=ftbutton3_white nowrap><a href="javascript:rest_del2('<?=$work_gbn_chk?>');" target="">삭제</a></td><td><img src=./images/btn1_rt.gif></td><td width=2></td></tr></table>
					</td>
					<td class="tdhead_center">시작</td>
<?
for($i=0;$i<7;$i++) {
...
if($i == 0) {
?>
						<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=./images/btn1_lt.gif></td><td background=./images/btn1_bg.gif class=ftbutton3_white nowrap><a href="javascript:resttime_sdate_copy2('<?=$work_gbn_chk?>');" target="">복사</a></td><td><img src=./images/btn1_rt.gif></td><td width=2></td></tr></table>
<?
}
?>
					</td>
...
if($i == 0) {
?>
						<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=./images/btn1_lt.gif></td><td background=./images/btn1_bg.gif class=ftbutton3_white nowrap><a href="javascript:resttime_edate_copy2('<?=$work_gbn_chk?>');" target="">복사</a></td><td><img src=./images/btn1_rt.gif></td><td width=2></td></tr></table>
<?
}
?>
					</td>
...
?>
				<tr id="rest_str3c" style="<? if($rest_shour3[0] == "") echo "display:none"; ?>">
					<td class="tdhead_center" rowspan="2">
						휴게시간3
						<table border=0 cellpadding=0 cellspacing=0 style="" align="center" id="rest_del_bt3c"><tr><td width=2></td><td><img src=./images/btn1_lt.gif></td><td background=./images/btn1_bg.gif class=ftbutton3_white nowrap><a href="javascript:rest_del3('<?=$work_gbn_chk?>');" target="">삭제</a></td><td><img src=./images/btn1_rt.gif></td><td width=2></td></tr></table>
					</td>
					<td class="tdhead_center">시작</td>
<?
for($i=0;$i<7;$i++) {
...
if($i == 0) {
?>
						<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=./images/btn1_lt.gif></td><td background=./images/btn1_bg.gif class=ftbutton3_white nowrap><a href="javascript:resttime_sdate_copy3('<?=$work_gbn_chk?>');" target="">복사</a></td><td><img src=./images/btn1_rt.gif></td><td width=2></td></tr></table>
<?
}
?>
					</td>
...
if($i == 0) {
?>
						<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=./images/btn1_lt.gif></td><td background=./images/btn1_bg.gif class=ftbutton3_white nowrap><a href="javascript:resttime_edate_copy3('<?=$work_gbn_chk?>');" target="">복사</a></td><td><img src=./images/btn1_rt.gif></td><td width=2></td></tr></table>
<?
}
?>
					</td>
...
if($i == 0) {
?>
						<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=./images/btn1_lt.gif></td><td background=./images/btn1_bg.gif class=ftbutton3_white nowrap><a href="javascript:exttime_sdate_copy('<?=$work_gbn_chk?>');" target="">복사</a></td><td><img src=./images/btn1_rt.gif></td><td width=2></td></tr></table>
<?
}
?>
					</td>
...
if($i == 0) {
?>
						<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=./images/btn1_lt.gif></td><td background=./images/btn1_bg.gif class=ftbutton3_white nowrap><a href="javascript:exttime_edate_copy('<?=$work_gbn_chk?>');" target="">복사</a></td><td><img src=./images/btn1_rt.gif></td><td width=2></td></tr></table>
<?
}
?>
					</td>
...
if($i == 0) {
?>
						<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=./images/btn1_lt.gif></td><td background=./images/btn1_bg.gif class=ftbutton3_white nowrap><a href="javascript:nighttime_sdate_copy('<?=$work_gbn_chk?>');" target="">복사</a></td><td><img src=./images/btn1_rt.gif></td><td width=2></td></tr></table>
<?
}
?>
					</td>
...
if($i == 0) {
?>
						<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=./images/btn1_lt.gif></td><td background=./images/btn1_bg.gif class=ftbutton3_white nowrap><a href="javascript:nighttime_edate_copy('<?=$work_gbn_chk?>');" target="">복사</a></td><td><img src=./images/btn1_rt.gif></td><td width=2></td></tr></table>
<?
}
?>
					</td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" style="table-layout:fixed">
				...
				<tr>
					...
					<td class="tdrow_center">
						...
						<input type="checkbox" name="manual_day_c" <?=$check_manual_day_c?> onclick="check_manual(this, 'c');" value="1" style="vertical-align:middle;" />수동
					</td>
					<td class="tdrow_center">
						...
						<input type="checkbox" name="manual_ext_c" <?=$check_manual_ext_c?> onclick="check_manual(this, 'c');" value="1" style="vertical-align:middle;" />수동
					</td>
					<td class="tdrow_center">
						...
						<input type="checkbox" name="manual_night_c" <?=$check_manual_night_c?> onclick="check_manual(this, 'c');" value="1" style="vertical-align:middle;" />수동
					</td>
					<td class="tdrow_center">
						...
						<input type="checkbox" name="manual_hday_c" <?=$check_manual_hday_c?> onclick="check_manual(this, 'c');" value="1" style="vertical-align:middle;" />수동
					</td>
				</tr>
			</table>
		</div>
...
?>
			<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" style="font-size:15px">
				...
				<col width=""/>
				<tr>
					<td class="tdrowk">주간근무시간 설정</td>
					<td class="tdrow">업체의 고정근로시간에 따라 A~C형을 선택합니다.</td>
				</tr>
				<tr>
					<td class="tdrowk">근무유형</td>
					<td class="tdrow">근무일 : 소정근로일<br>
					무급휴일 : 휴일 근무시 휴일근로수당 지급(기본 무급처리)<br>
					무급휴무일 : 휴무일 근무시 연장근로수당 지급(기본 무급처리)<br>
					유급휴일 : 휴일 근무시 휴일근로수당 지급(기본 유급처리)
					</td>
				</tr>
			</table>
