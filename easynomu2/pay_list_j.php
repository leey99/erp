...
?>
	...
	//alert( "("+money_total+" - "+money_e_sum+") + "+money_e_income_sum);
...
function focusOutClass(idx) {
	...
	if(frm.idx[idx].checked == false) {
		...
		frm.money_ext[idx].className = "textfm";
		frm.money_hday[idx].className = "textfm";
		frm.money_night[idx].className = "textfm";
														...
														<td>  
															<table width="<?=$pay_list_width?>" border="0" cellpadding="0" cellspacing="1" class="bgtable" style="table-layout:;">
																<tr>
																	...
																	<td class="tdhead_center" colspan="6">기본급 및 제수당 </td>
																	<td class="tdhead_center" rowspan="4" width="18"></td>
																...
																<tr>
																	<td class="tdhead_center" rowspan="3" width="66">결정임금</td>
																	...
																	<td class="tdhead_center" colspan="6">기본월급</td>
																	...
																	<td class="tdhead_center" rowspan="3" width="69">과세소득</td>
																	...
																	<td class="tdhead_center" rowspan="3" width="60">공제계</td>
																</tr>
																<tr>
																	...
																	<td class="tdhead_center" rowspan="2" width="107">통상시급</td>
																	<td class="tdhead_center" rowspan="2" width="108">기본시급</td>
																	<td class="tdhead_center" rowspan="2" width="130">기본급</td>
																	<td class="tdhead_center" colspan="3">법정수당(과세)</td>
																	...
																	<td class="tdhead_center" rowspan="2" width="58">국민<br>연금</td>
																	<td class="tdhead_center" rowspan="2" width="58">건강<br>보험</td>
																	<td class="tdhead_center" rowspan="2" width="58">장기<br>요양</td>
																	<td class="tdhead_center" rowspan="2" width="58">고용<br>보험</td>
																	<td class="tdhead_center" rowspan="2" width="58">소득세</td>
																	<td class="tdhead_center" rowspan="2" width="58">주민세</td>
																	<td class="tdhead_center" rowspan="2" width="62">기타<br>공제</td>
																</tr>
																<tr>
																	<td class="tdhead_center" width="115">연장근로</td>
																	<td class="tdhead_center" width="115">야간근로</td>
																	<td class="tdhead_center" width="115">휴일근로</td>
...
?>
														<td nowrap class="ltrow1_center_h24"><b onclick="clientxy();emp_text('<?=$row[name]?>','<?=$row[in_day]?>','<?=$row_position[name]?>','<?=$row2[family_cnt]?>','<?=$row2[work_gbn]?>','<?=$pay_gbn.$input_type?>');" style="cursor:pointer"><?=$name?></b></td>
											...
											<div id="spanMain" style="width:100%;height:<?=$spanMain_height?>px;overflow-x:hidden;overflow-y:auto;" onScroll="spanLeft.scrollTop = this.scrollTop; spanTop.scrollLeft = this.scrollLeft;">
												<table width="<?=$pay_list_width?>" border="0" cellpadding="0" cellspacing="1" class="bgtable" style="table-layout:fixed;">
													...
													for ($i=0; $row=sql_fetch_array($result); $i++) {
														...
														//근태관리 DB
														$sql_attendance = " select * from a4_attendance where com_code='$row[com_code]' and sabun='$row[sabun]' and att_day like '".$search_year."".$search_month."%' ";
														//echo $sql_attendance;
...
if($row4[money_month] == 0 || $data == "load") {
	...
	for($j=0; $row_attendance=sql_fetch_array($result_attendance); $j++) {
		...
		if($att_date[0] == $search_year && $att_date[1] == $search_month) {
			...
			//echo $row_attendance[att_time]."~".$row_attendance[att_time2]." / ";
			...
			//echo $row[name].": ".$att_rule_min." / ";
			if($att_rule_min > 59) {
				$att_rule_min = 60 - $att_rule_min;
			...
			//연차적용
			if($row_attendance[att_annual_paid_holiday] == 1) {
				$att_rule[$att_category] = 0;
			} else {
			...
			else if($att_category == 1) $w_absence += $att_rule[$att_category];
		}
		//echo $w_leave;
	}
	//소수점 2자리
	$w_late = round($w_late, 2);
	$w_leave = round($w_leave, 2);
	$w_out = round($w_out, 2);
	$w_absence = round($w_absence, 2);
	//근태DB 없을 경우
	if($j == 0) {
		$w_late = "";
		$w_leave = "";
...
?>
														...
														<td nowrap class="ltrow1_center_h24" width="62"><input type="text" style="width:100%;ime-mode:disabled;" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm5" readonly name="workhour_total" value="<?=$workhour_total?>"></td><!-- 임금산출 총시간 -->
														<td nowrap class="ltrow1_center_h24" width="18"></td>

														<td nowrap class="ltrow1_center_h24" width="107"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_hour_ts" value="<?=number_format($money_hour_ts)?>"></td><!-- 통상임금(시간급) -->
														<td nowrap class="ltrow1_center_h24" width="107"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_time" value="<?=number_format($money_time)?>"></td><!-- 기본시급 -->
														<td nowrap class="ltrow1_center_h24" width="129"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_base" value="<?=number_format($money_base)?>" onchage="this.form.money_month_var[].value='this.value';"></td><!-- 기본급 -->
														<td nowrap class="ltrow1_center_h24" width="115"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_ext" value="<?=number_format($money_ext)?>"></td><!-- 연장근로수당 -->
														<td nowrap class="ltrow1_center_h24" width="114"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_night" value="<?=number_format($money_night)?>"></td><!-- 야간근로수당 -->
														<td nowrap class="ltrow1_center_h24" width="114"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_hday" value="<?=number_format($money_hday)?>"></td><!-- 휴일근로수당 -->
														...
														<td nowrap class="ltrow1_center_h24" width="70"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="etc2" value="<?=number_format($row4[etc2])?>"   onKeyUp="checkThousand(this.value, this,'Y');cal_pay('<?=$k?>');"></td><!-- 근태공제 -->
														<td nowrap class="ltrow1_center_h24" width="18"></td>
														...
														<td nowrap class="ltrow1_center_h24" width="69"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm5" readonly name="money_for_tax" value="<?=number_format($row4[money_for_tax])?>"></td><!-- 과세소득 -->

														<td nowrap class="ltrow1_center_h24" width="58"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_yun" value="<?=number_format($row4[yun])?>" onKeyUp="checkThousand(this.value, this,'Y');cal_pay2('<?=$k?>');"></td><!-- 국민연금 -->
														<td nowrap class="ltrow1_center_h24" width="58"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber_negative();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_health" value="<?=number_format($row4[health])?>" onKeyUp="checkThousand_negative(this.value, this,'Y');cal_pay2('<?=$k?>');"></td><!-- 건강보험 -->
														<td nowrap class="ltrow1_center_h24" width="58"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber_negative();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_yoyang" value="<?=number_format($row4[yoyang])?>" onKeyUp="checkThousand_negative(this.value, this,'Y');cal_pay2('<?=$k?>');"></td><!-- 장기요양보험 -->
														<td nowrap class="ltrow1_center_h24" width="58"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_goyong" value="<?=number_format($row4[goyong])?>" onKeyUp="checkThousand(this.value, this,'Y');cal_pay2('<?=$k?>');"></td><!-- 고용보험 -->
														<td nowrap class="ltrow1_center_h24" width="58"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="tax_so" value="<?=number_format($row4[tax_so])?>" onKeyUp="checkThousand(this.value, this,'Y');cal_pay3('<?=$k?>');"></td><!-- 소득세 -->
														<td nowrap class="ltrow1_center_h24" width="58"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="tax_jumin" value="<?=number_format($row4[tax_jumin])?>" onKeyUp="checkThousand(this.value, this,'Y');cal_pay2('<?=$k?>');"></td><!-- 주민세 -->
														<td nowrap class="ltrow1_center_h24" width="62"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="minus" value="<?=number_format($row4[minus])?>" onKeyUp="checkThousand(this.value, this,'Y');cal_pay2('<?=$k?>');"></td><!-- 기타공제 -->

														<td nowrap class="ltrow1_center_h24" width="60"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm5" readonly name="money_gongje" value="<?=number_format($row4[money_gongje])?>"></td><!-- 공제계 -->
														<td nowrap class="ltrow1_center_h24" width="74"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm5" readonly name="money_result" value="<?=number_format($row4[money_result])?>"></td><!-- 공제후지급액 -->
														<td nowrap class="ltrow1_center_h24" width="18"></td>
													</tr>
