...
/*
//수정 (급여대장 히스토리 기능으로 주석 14.06.23)
if ($total_opt1) {
//기존 데이터 삭제
	$sql_delete = " delete from pibohum_base_pay where com_code = '$code' and year = '$search_year' and month = '$search_month' $pay_gbn_sql ";
...
//수동입력
$manual = $manual_ext.",".$manual_night.",".$manual_hday.",".$manual_4insure.",".$manual_tax;
...
//exit;
//기본, 전체, 사무직, 현장직 급여저장
//if($mode == "input" || $mode == "all" || $mode == "white" || $mode == "blue") {
if($mode != 'preview') {
	...
	//전체
	if($mode == "all") $pay_list_url = "pay_all.php";
	else if($mode == "white") $pay_list_url = "pay_white.php";
	else if($mode == "blue") $pay_list_url = "pay_blue.php";
