...
$sql_pay = " select * from pibohum_base_pay_helper where com_code='$code' and sabun='$id' and year = '$search_year' and month = '$search_month' order by w_date desc, w_time desc limit 0, 1 ";
//echo $sql_pay;
...
<script src="./js/pay_stubs_helper.js" type="text/javascript" charset="euc-kr"></script>
</body>
</html>
