...
$file_name = $com_name."_활동보조인_급여대장_".$search_year."_".$search_month.".xls";
header("Pragma:");
...
<table width="1200" border="1" cellspacing="1" cellpadding="3">
	...
	<tr>
		...
		<td bgcolor="#65CBFF" align="center" rowspan="2"><?=iconv("EUC-KR", "UTF-8", "서비스<br>이용금액")?></td>
		<td bgcolor="#65CBFF" align="center" rowspan="2"><?=iconv("EUC-KR", "UTF-8", "총<br>근로시간")?></td>
		<td bgcolor="#65CBFF" align="center" colspan="3"><?=iconv("EUC-KR", "UTF-8", "근로시간")?></td>
		<td bgcolor="#65CBFF" align="center" colspan="2"><?=iconv("EUC-KR", "UTF-8", "보건복지")?></td>
		<td bgcolor="#65CBFF" align="center" colspan="2"><?=iconv("EUC-KR", "UTF-8", "경기도")?></td>
		<td bgcolor="#65CBFF" align="center" colspan="2"><?=iconv("EUC-KR", "UTF-8", "화성시")?></td>
		...
		<td bgcolor="#65CBFF" align="center" rowspan="2"><?=iconv("EUC-KR", "UTF-8", "가산<br />수당")?></td>
		<td bgcolor="#65CBFF" align="center" rowspan="2"><?=iconv("EUC-KR", "UTF-8", "급여")?></td>
		<td bgcolor="#65CBFF" align="center" colspan="3"><?=iconv("EUC-KR", "UTF-8", "급여내역")?></td>
	...
	<tr>
		<td bgcolor="#65CBFF" align="center"><?=iconv("EUC-KR", "UTF-8", "보건복지")?></td>
		<td bgcolor="#65CBFF" align="center"><?=iconv("EUC-KR", "UTF-8", "경기도")?></td>
		<td bgcolor="#65CBFF" align="center"><?=iconv("EUC-KR", "UTF-8", "화성시")?></td>
		<td bgcolor="#65CBFF" align="center"><?=iconv("EUC-KR", "UTF-8", "평근")?></td>
		<td bgcolor="#65CBFF" align="center"><?=iconv("EUC-KR", "UTF-8", "휴심")?></td>
		<td bgcolor="#65CBFF" align="center"><?=iconv("EUC-KR", "UTF-8", "평근")?></td>
		<td bgcolor="#65CBFF" align="center"><?=iconv("EUC-KR", "UTF-8", "휴심")?></td>
		<td bgcolor="#65CBFF" align="center"><?=iconv("EUC-KR", "UTF-8", "평근")?></td>
		<td bgcolor="#65CBFF" align="center"><?=iconv("EUC-KR", "UTF-8", "휴심")?></td>
		<td bgcolor="#65CBFF" align="center"><?=iconv("EUC-KR", "UTF-8", "교육시간")?></td>
		<td bgcolor="#65CBFF" align="center"><?=iconv("EUC-KR", "UTF-8", "스마트폰")?></td>
		<td bgcolor="#65CBFF" align="center"><?=iconv("EUC-KR", "UTF-8", "보건복지")?></td>
		<td bgcolor="#65CBFF" align="center"><?=iconv("EUC-KR", "UTF-8", "경기도")?></td>
		<td bgcolor="#65CBFF" align="center"><?=iconv("EUC-KR", "UTF-8", "화성시")?></td>
...
?>
	<tr>
		...
		<td align="center"><?=$w_1_s?></td>
		<td align="center"><?=$w_2_s?></td>
		<td align="center"><?=$w_3_s?></td>
		...
		<td align="center"><?=number_format($w_3_pay)?></td>
...
$sql_search2 .= " and  money_total = 0 and (money_result != 0  or c_money_gongje != 0) ";
$sql = " select count(*) as cnt
          $sql_common
          $sql_search $sql_search2 ";
$row = sql_fetch($sql);
...
?>
	<tr>
		...
		<td align="center" rowspan="2"><?=number_format($money_total_sum)?></td>
		<td align="center" rowspan="2"><?=number_format($w_sum_sum)?></td>
		<td align="center" rowspan="2"><?=number_format($w_1_s_sum)?></td>
		<td align="center" rowspan="2"><?=number_format($w_2_s_sum)?></td>
		<td align="center" rowspan="2"><?=number_format($w_3_s_sum)?></td>
		<td align="center" rowspan="2"><?=number_format($w_1_sum)?></td>
		<td align="center" rowspan="2"><?=number_format($w_1_hday_sum)?></td>
		<td align="center" rowspan="2"><?=number_format($w_2_sum)?></td>
		<td align="center" rowspan="2"><?=number_format($w_2_hday_sum)?></td>
		<td align="center" rowspan="2"><?=number_format($w_3_sum)?></td>
		<td align="center" rowspan="2"><?=number_format($w_3_hday_sum)?></td>
		<td align="center" rowspan="2"><?=number_format($w_edu_sum)?></td>
		<td align="center" rowspan="2"><?=number_format($w_phone_sum)?></td>
		<td align="center" rowspan="2"><?=number_format($annual_paid_holiday_sum)?></td>
		<td align="center" rowspan="2"><?=number_format($b1_sum)?></td>
		...
		<td align="center" rowspan="2"><?=number_format($w_3_pay_sum)?></td>
