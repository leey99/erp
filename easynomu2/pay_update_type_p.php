...
for($i=0;$i<$total_count;$i++) {
	...
	$money_period_var[$i] = $_POST['money_period_var_'.$i];
	...
	$money_period_var[$i] = preg_replace('@,@', '', $money_period_var[$i]);
	...
	$sql_common = " 
							...
							money_period = '$money_period_var[$i]',
