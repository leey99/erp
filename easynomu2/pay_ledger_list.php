									...
									if($search_month || $year != $old_year || $month != $old_month || $i == 0) {
										...
										if($member['mb_profile'] == "guest") {
											...
											if($com_code == "20602") {
												...
												$url_pay_ledger = "pay_month_list.php?w=u&code=".$code."&search_year=".$row['year']."&search_month=".$row['month']."&w_date=".$reg_day."&w_time=".$reg_time;
											}
										...
										$url_pay_ledger_list = "pay_ledger_list.php?search_year=".$row['year']."&search_month=".$row['month'];
								?>
<?
if($search_month) {
	$w_gubun = "";
