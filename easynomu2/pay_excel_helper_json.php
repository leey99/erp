...
/*
$sql = "insert pibohum_base_pay_helper set 
		memo1 = '$jData_org'
...
/*
	if($i == 1) {
		...
		$sql = "insert pibohum_base_pay_helper set memo1 = '$sql_common_esc', com_code = '20399', sabun = '9999', year = '2016', month = '' ";
		sql_query($sql);
	}
*/
	//기존 데이터 유무
	$sql_opt1 = "select * from pibohum_base_pay_helper 
	...
	//수정
	if($total_opt1) {
		$sql = "update pibohum_base_pay_helper set 
				$sql_common 
				where com_code = '$code' and sabun = '$sabun[$i]' and year = '$search_year' and month = '$search_month' ";
	//등록
	} else {
...
/*
		...
		$sql_esc = "insert pibohum_base_pay_helper set memo1 = '$sql_common_esc', com_code = '20399', sabun = '9999', year = '2016', month = '' ";
		sql_query($sql_esc);
*/
	}
	sql_query($sql);
