...
function func_4insure(mode) {
	...
	var msg = "";
	if(mode == "in") msg = "정말 취득신고 하시겠습니까?";
	else if(mode == "out") msg = "정말 상실신고 하시겠습니까?";
	else if(mode == "modify") msg = "정말 변경신고 하시겠습니까?";
	if(cnt==0) {
	 alert("선택된 근로자가 없습니다.");
	 return;
	} else{
...
?>
									...
									<td nowrap class="tdhead_center" width="78"><a href="<?=$sort_position?>">직위</a></td>
									<td nowrap class="tdhead_center" width="105"><a href="<?=$sort_dept?>">부서</a></td>
									<td nowrap class="tdhead_center" width="100"><a href="<?=$sort_jumin_no?>">주민등록번호</a></td>
									<td nowrap class="tdhead_center" width="50">만나이</a></td>
									<td nowrap class="tdhead_center" width="70"><a href="<?=$sort_in_day?>">입사일</a></td>
									<td nowrap class="tdhead_center" width="70"><a href="<?=$sort_out_day?>">퇴사일</a></td>
...
?>
									...
									<td nowrap class="ltrow1_center_h22">만 <?=$age?></td>
