...
//급여관리 DB (급여반영) 년월
if($comp_print_type == "H") $sql_w_date = " select * from pibohum_base_pay_h where com_code='$com_code' and year = '$search_year' and month = '$search_month' ";
...
//페이지 타이틀
//화성시장애인부모회 활동보조인
if($comp_print_type == "H") $sub_title = "급여계산(활동보조인)";
else $sub_title = "급여계산(시급제)";
...
//화성시장애인보모회 활동보조인, 헬퍼
	...
	if($search_year <= 2013) include "pay_list_h_2013.php";
	else include "pay_list_h.php";
} else {
