...
for ($i=0; $row=sql_fetch_array($result); $i++) {
	...
	//가산수당 160408
	if($row4['b1']) $b1 = number_format($row4['b1']);
	else $b1 = "";
	...
	$workhour_1_hday_ary[$i] = $workhour_1_hday;
	$workhour_2_ary[$i] = $workhour_2;
	$workhour_2_hday_ary[$i] = $workhour_2_hday;
	$workhour_3_ary[$i] = $workhour_3;
	$workhour_3_hday_ary[$i] = $workhour_3_hday;
...
//템플릿 엑셀 파일
$file = "excel/pay_excel_beistand.xlsx";
$objReader = PHPExcel_IOFactory::createReaderForFile($file);
$objPHPExcel = new PHPExcel();
$objPHPExcel = $objReader->load($file);
//엑셀 파일명
$file_name = $com_name."_활보_".$search_year."년_".$search_month."월.xls";
//셀 색상
$styleArray = array(
    'fill' => array(
...
for($i=0;$i<$total_count;$i++) {
	...
	$objPHPExcel->setActiveSheetIndex(0)
							...
							->setCellValueExplicit("F$k", $workhour_1_ary[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("G$k", $workhour_1_hday_ary[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("H$k", $workhour_2_ary[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("I$k", $workhour_2_hday_ary[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("J$k", $workhour_3_ary[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("K$k", $workhour_3_hday_ary[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("L$k", $workhour_edy_ary[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("M$k", $workhour_phone_ary[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("N$k", $annual_paid_holiday_ary[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("O$k", $b1_ary[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("P$k", $yun[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("Q$k", $health[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("R$k", $yoyang[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("S$k", $goyong[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("T$k", $tax_so[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("U$k", $tax_jumin[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("V$k", $minus[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("W$k", $c_yun[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("X$k", $c_health[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("Y$k", $c_yoyang[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("Z$k", $c_goyong[$i], PHPExcel_Cell_DataType::TYPE_STRING)
							->setCellValueExplicit("AA$k", $c_sanjae[$i], PHPExcel_Cell_DataType::TYPE_STRING);
	//셀 색상 회색 처리
