...
if($w == "u") {
	...
	//사원정보 DB
	$sql1 = " select * $sql_common where com_code='$row_nomu[com_code]' and sabun='$row_nomu[sabun]' ";
	//echo $sql1;
	$result1 = sql_query($sql1);
	//사원DB 옵션
	$sql2 = " select * from pibohum_base_opt where com_code='$row_nomu[com_code]' and sabun='$row_nomu[sabun]' ";
...
function checkData() {
	...
	if(frm.vacation_sdate.value == "") {
		alert("기간을 입력하세요.");
		frm.vacation_sdate.focus();
		return;
	}
	if(frm.vacation_edate.value == "") {
		alert("기간을 입력하세요.");
		frm.vacation_edate.focus();
		return;
	}
	if(radio_chk(frm.vacation_cause,"구분을") == 0) {
		return;
	}
	frm.action = "vacation_update.php";
	frm.submit();
	return;
}
...
?>
								...
								<tr>
									<td nowrap class="tdrowk"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5 3 0">기간<font color="red">*</font></td>
									<td nowrap  class="tdrow">
										<input name="vacation_sdate" type="text" class="textfm" style="width:76px;" value="<?=$row_nomu[vacation_sdate]?>" maxlength="10">
										<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=./images/btn2_lt.gif></td><td background=./images/btn2_bg.gif class=ftbutton3_white nowrap><a href="javascript:loadCalendar(document.dataForm.vacation_sdate);" target="">달력</a></td><td><img src=./images/btn2_rt.gif></td><td width=2></td></tr></table> ~
										<input name="vacation_edate" type="text" class="textfm" style="width:76px;" value="<?=$row_nomu[vacation_edate]?>" maxlength="10">
										<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=./images/btn2_lt.gif></td><td background=./images/btn2_bg.gif class=ftbutton3_white nowrap><a href="javascript:loadCalendar(document.dataForm.vacation_edate);" target="">달력</a></td><td><img src=./images/btn2_rt.gif></td><td width=2></td></tr></table>
									</td>
								</tr>
								<tr>
									<td nowrap class="tdrowk"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5 3 0">구분<font color="red">*</font></td>
									<td nowrap  class="tdrow">
<?
//휴가구분
...
?>
										<br>
										<input type="radio" name="vacation_cause" value="<?=$i?>" <? if($i == $row_nomu[vacation_cause]) echo "checked"; ?> /><?=$cause_array[$i]?>
<?
	} else {
?>
										<input type="radio" name="vacation_cause" value="<?=$i?>" <? if($i == $row_nomu[vacation_cause]) echo "checked"; ?> /><?=$cause_array[$i]?>
...
?>
								...
								<tr>
									<td nowrap class="tdrowk"><img src="./images/icon_02.gif" width="2" height="2" style="margin:0 5 3 0">사유</td>
									<td nowrap  class="tdrow">
										<input type="text" name="vacation_reason" class="textfm" style="width:600px;" value="<?=$row_nomu[vacation_reason]?>" maxlength="" />
									</td>
								</tr>
							</table>
...
if($w == "u") {
?>
										<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=images/btn_lt.gif></td><td background=images/btn_bg.gif class=ftbutton1 nowrap><a href="javascript:del('<?=$item?>',<?=$page?>,<?=$id?>);" target="">삭 제</a></td><td><img src=images/btn_rt.gif></td><td width=2></td></tr></table>
<? } ?>
										<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=images/btn_lt.gif></td><td background=images/btn_bg.gif class=ftbutton1 nowrap><a href="./vacation.php?page=<?=$page?>" target="">목 록</a></td><td><img src=images/btn_rt.gif></td><td width=2></td></tr></table>
									</td>
								</tr>
							</table>
