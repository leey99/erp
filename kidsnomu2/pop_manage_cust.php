...
$sql = " select * from a4_manage where item='manage' ";
//echo $sql;
...
?>
					<tr class="list_row_now_wh" onMouseOver="this.className='list_row_over';" onMouseOut="this.className='list_row_now_wh';">
						...
						<td nowrap class="ltrow1_center_h22"><?=$state?></td>
						...
						<td height="40">
                            ...
                            <table width="70%" height="15" border="0" cellpadding="0" cellspacing="0">
                              <tr>
								...
								<img src="./images/gray_list_pre.gif" width="30" height="15" align="absmiddle">
								...
								<img src="./images/gray_list_next.gif" width="30" height="15" align="absmiddle">
