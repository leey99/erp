														...
														<td>  
															<table width="<?=$pay_list_width?>" border="0" cellpadding="0" cellspacing="1" class="bgtable" style="table-layout:;">
																...
																<tr>
																	...
																	<td class="tdhead_center" colspan="6">제수당</td>
																...
																<tr>
																	...
																	<td class="tdhead_center" colspan="6">통상임금수당</td>
...
?>
																...
																<tr>
																	<td class="tdhead_center" width="110"><input type="checkbox" name="manual_ext" <?=$check_manual_ext?> onclick="check_manual(this);" value="1" title="수동입력" style="vertical-align:middle;"> 시간외수당</td>
																	...
																	<td class="tdhead_center" width="110"><input type="checkbox" name="manual_hday" <?=$check_manual_hday?> onclick="check_manual(this);" value="1" title="수동입력" style="vertical-align:middle;"> 휴일근로수당</td>
																	<td class="tdhead_center" width="101">연차수당</td>



																	<td class="tdhead_center" width="115"><input type="text" name="g1" class="textfm5" readonly  style="width:100%;" value="<?=$money_g_txt['g1']?>"></td>
																	<td class="tdhead_center" width="115"><input type="text" name="g2" class="textfm5" readonly  style="width:100%;" value="<?=$money_g_txt['g2']?>"></td>
																	<td class="tdhead_center" width="115"><input type="text" name="g3" class="textfm5" readonly  style="width:100%;" value="<?=$money_g_txt['g3']?>"></td>
																	<td class="tdhead_center" width="115"><input type="text" name="g4" class="textfm5" readonly  style="width:100%;" value="<?=$money_g_txt['g4']?>"></td>
																	<td class="tdhead_center" width="115"><input type="text" name="g5" class="textfm5" readonly  style="width:100%;" value="<?=$money_g_txt['g5']?>"></td>
																	<td class="tdhead_center" width="115"><input type="text" name="g6" class="textfm5" readonly  style="width:100%;" value="<?=$money_g_txt['g6']?>"></td>
...
?>
											<div id="spanLeft" style="width:200px;height:<?=$spanMain_height?>px;overflow:hidden">
												<div style="display:none;">
													...
													<input type="hidden" name="money_g6">
...
?>
														...
														<td nowrap class="ltrow1_center_h24" width="114"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_g1" id="id_money_g1_<?=$k?>" value="<?=number_format($money_g1)?>" onkeyup="checkThousand(this.value, this,'Y');cal_pay('<?=$k?>');" onkeydown="if(event.keyCode == 13){ getId('id_money_g1_<?=$k_next?>').focus(); }"></td><!-- 고정성1 -->
														<td nowrap class="ltrow1_center_h24" width="114"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_g2" id="id_money_g2_<?=$k?>" value="<?=number_format($money_g2)?>" onkeyup="checkThousand(this.value, this,'Y');cal_pay('<?=$k?>');" onkeydown="if(event.keyCode == 13){ getId('id_money_g2_<?=$k_next?>').focus(); }"></td><!-- 고정성2 -->
														<td nowrap class="ltrow1_center_h24" width="114"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_g3" id="id_money_g3_<?=$k?>" value="<?=number_format($money_g3)?>" onkeyup="checkThousand(this.value, this,'Y');cal_pay('<?=$k?>');" onkeydown="if(event.keyCode == 13){ getId('id_money_g3_<?=$k_next?>').focus(); }"></td><!-- 고정성3 -->
														<td nowrap class="ltrow1_center_h24" width="114"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_g4" id="id_money_g4_<?=$k?>" value="<?=number_format($money_g4)?>" onkeyup="checkThousand(this.value, this,'Y');cal_pay('<?=$k?>');" onkeydown="if(event.keyCode == 13){ getId('id_money_g4_<?=$k_next?>').focus(); }"></td><!-- 고정성4 -->
														<td nowrap class="ltrow1_center_h24" width="114"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_g5" id="id_money_g5_<?=$k?>" value="<?=number_format($money_g5)?>" onkeyup="checkThousand(this.value, this,'Y');cal_pay('<?=$k?>');" onkeydown="if(event.keyCode == 13){ getId('id_money_g5_<?=$k_next?>').focus(); }"></td><!-- 고정성5 -->
														<td nowrap class="ltrow1_center_h24" width="114"><input type="text" style="width:100%;ime-mode:disabled;text-align:right" onKeyPress="onlyNumber();" onfocusin="javascript:focusInClass('<?=$k?>');" onfocusout="javascript:focusOutClass('<?=$k?>');" class="textfm" name="money_g6" id="id_money_g6_<?=$k?>" value="<?=number_format($money_g6)?>" onkeyup="checkThousand(this.value, this,'Y');cal_pay('<?=$k?>');" onkeydown="if(event.keyCode == 13){ getId('id_money_g6_<?=$k_next?>').focus(); }"></td><!-- 고정성6 -->
														<td nowrap class="ltrow1_center_h24" width="18"></td>
...
function cal_pay(idx) {
	...
	var money_g1,money_g2,money_g3,money_g4,money_g5,money_g6,money_e1,money_e2,money_e3,money_e4,money_e5,money_e6,money_e7,money_e8;
	...
	money_g6        = toInt(f.money_g6      [idx].value);
...
*/
	...
	//통상임금수당 합계
	money_g_sum = money_g1+money_g2+money_g3+money_g4+money_g5+money_g6;
