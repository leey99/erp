...
//echo $is_admin;
if($is_admin == "super") {
	$sql_search = " where 1=1 and quit_cause != '0' ";
} else {
...
?>
									...
									<td nowrap class="tdhead_center" width="90">입사일/퇴직일</td>
									<td nowrap class="tdhead_center" width="90">퇴직금</td>
									<td nowrap class="tdhead_center" width="">퇴직구분/퇴직사유</td>
...
for ($i=0; $row=sql_fetch_array($result); $i++) {
	...
	//퇴직사유 (사원DB 노무)
	$retire_reason = cut_str($row[retire_reason], 24, "..");
	//퇴직구분
	$retire_cause = $row['quit_cause_text'];
?>
...
<? } ?>
									...
									<td nowrap class="ltrow1_center_h22"><?=$in_day?><br /><?=$out_day?></td>
									<td nowrap class="ltrow1_center_h22"><?=$retire_pay?></td>
									<td nowrap class="ltrow1_left_h22"><?=$retire_cause?><br /><?=$retire_reason?></td>
									...
									<td nowrap class="ltrow1_center_h22">
										<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=images/btn_lt.gif></td><td background=images/btn_bg.gif class=ftbutton1 nowrap><a href="retirement_view.php?w=u&idx=<?=$idx?>&id=<?=$id?>&code=<?=$code?>&page=<?=$page?>" target="">수정</a></td><td><img src=images/btn_rt.gif></td><td width=2></td></tr></table> 
									</td>
								</tr>
								</tr>
								<?
...
if($member['mb_level'] == 6) {
	...
	$url_form = "retirement_form.php?page=$page";
}
?>
									...
									<td align="left">
										...
										<table border=0 cellpadding=0 cellspacing=0 style="display:inline;">
											<tr>
												<td width=2></td>
												<td><img src=images/btn_lt.gif></td>
												<td background=images/btn_bg.gif class=ftbutton1 nowrap><a href="<?=$url_form?>" target="">근로자명부(퇴직자)</a></td>
												<td><img src=images/btn_rt.gif></td>
											 <td width=2></td>
											</tr>
										</table>
