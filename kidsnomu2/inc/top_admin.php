		...
		<tr>
			<td align=center>
				<table width="<?=$top_width?>" align="center" border="0" cellpadding="0" cellspacing="0" style="margin:0 <?=$margin_right?>px 0 0;">
					<tr>
						<td width="200" align="left"><a href="main.php" target=""><img src="images/logo_kidsnomu.png" /></a></td>
...
?>
		...
		<tr>
			<td align="center" style="border-bottom:1px solid #b0a28f">
...
if($member['mb_level'] == 7 && $member['mb_profile'] != 1) {
	$menu7_url = "javascript:alert_no_right();";
	$menu9_url = "javascript:alert_no_right();";
	$menu10_url = "javascript:alert_no_right();";
	$menu11_url = "javascript:alert_no_right();";
} else {
	$menu7_url = "4insure_list_admin.php";
	$menu9_url = "total_pay_list_admin.php";
	$menu10_url = "a4_modify_list_admin.php";
	$menu11_url = "adjustment_list_admin.php";
}
?>
				<table width="<?=$top_width?>" height="45" border="0" align="center" cellpadding="0" cellspacing="0" style="margin:0 <?=$margin_right?>px 0 0">
					<tr>
<?
...
?>
						<td width="145" align="left"><div align="center"><a href='<?=$menu12_url?>' target="" onmouseover='img12.src="images/menu12_on.gif";' onmouseout='img12.src="images/menu12_off.gif"'><img src='images/menu12_off.gif' name='img12' border="0" id="img12" /></a></div></td>
						<td width="145" align="left"><div align="center"><a href='<?=$menu11_url?>' target="" onmouseover='img11.src="images/menu11_on.gif";' onmouseout='img11.src="images/menu11_off.gif"'><img src='images/menu11_off.gif' name='img11' border="0" id="img11" /></a></div></td>
