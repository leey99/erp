...
?>
								...
								<tr>
									...
									<td nowrap  class="tdrow">
<?
if($row['account_report_way'] == "1") $sel_account_report_way = "반기";
else if($row['account_report_way'] == "2") $sel_account_report_way = "월별";
...
?>
										<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=images/btn_lt.gif></td><td background=images/btn_bg.gif class=ftbutton1 nowrap><a href="./com_list.php?page=<?=$page?>" target="">목 록</a></td><td><img src=images/btn_rt.gif></td><td width=2></td></tr></table>
<?
} else {
?>
										<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=images/btn_lt.gif></td><td background=images/btn_bg.gif class=ftbutton1 nowrap><a href="./main.php" target="">취 소</a></td><td><img src=images/btn_rt.gif></td><td width=2></td></tr></table>
