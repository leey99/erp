...
$subject = "[키즈노무] 월평균보수 변경 신고 접수 되었습니다.";
$content = "<span style='font-size:9pt;'>[키즈노무] ".$comp_name." 월평균보수 변경 신고 접수 되었습니다.<p>";
$content .= "<a href=\"http://www.kidsnomu.com/kidsnomu/a4_modify_list_admin.php\">☞ 월평균보수 변경 신고 접수 리스트</a></p><p>아이디 : bs0002 / 패스워드 : 1234<p></p>".date("Y-m-d H:i:s")."<p>이 메일 주소로는 회신되지 않습니다.</p></span>";
