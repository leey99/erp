...
/*
echo $com_code." ".$search_year." ".$search_month."<br>";
echo $send_year." ".$send_month;
exit;
*/
//첨부파일 경로
...
$pic_name_sql_4 = "";
//첨부서류3
//echo 'filename_4_'.$send_year.'_'.$send_month;
//echo $_FILES['filename_4_'.$send_year.'_'.$send_month]['tmp_name'];
//exit;
...
//원천세 신고 사업장 정보 id 추출
$sql_account = " select * from tax_account where comp_code='$com_code' ";
$result_account = sql_query($sql_account);
...
//기존 데이터 삭제 후 삽입 으로 변경 요망 160707 / 기존 데이터 삭제, 데이터 삽입 160929
$sql_opt_del = " delete from tax_account_opt where com_code = '$com_code' and year = '$send_year' and month = '$send_month' ";
