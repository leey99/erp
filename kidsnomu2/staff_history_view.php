...
$sql2 = " select * from pibohum_bak_opt where id = '$idx' ";
$result2 = sql_query($sql2);

$sql4 = " select * from pibohum_bak_opt2 where id = '$idx' ";
...
for ($i=0; $row=sql_fetch_array($result); $i++) {
	...
	//사원 추가 DB
	$sql_opt = " select * from pibohum_bak_opt where id='$row[id]' ";
	...
	//변경일자
	$sql_bak_opt2 = " select max(wr_date) as modify_date from pibohum_bak_opt2 where id='$row[id]' ";
	$result_bak_opt2 = sql_query($sql_bak_opt2);
	$row_bak_opt2=mysql_fetch_array($result_bak_opt2);
	$modify_date = $row_bak_opt2[modify_date];
	//급여정보
	$sql_bak_opt2 = " select * from pibohum_bak_opt2 where id='$row[id]' ";
	$result_bak_opt2 = sql_query($sql_bak_opt2);
	$row_bak_opt2=mysql_fetch_array($result_bak_opt2);
	//링크값
	$staff_url = "staff_history_view.php?id=".$id."&code=".$code."&idx=".$idx;
?>
							...
							<div id="tab1">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" style="">
									...
									<tr>
										...
										<td nowrap class="tdrow">
											...
											$work_form_txt[2] = "계약직";
											$work_form_txt[3] = "일용직";
											$work_form_code = $row1[work_form];
											echo $work_form_txt[$work_form_code];
											?>
										</td>
									...
									<tr id="contract_term" style="<? if($row1[work_form] == 1) echo "display:none"; ?>">
									...
									<tr>
										...
										<td nowrap class="tdrow">
											<input type="checkbox" name="insurance" value="1" class="checkbox" disabled <?=$insurance_chk?>> 두루누리 사회보험
										</td>
									</tr>
									<tr>
										...
										<td nowrap class="tdrow">
											...
											else if($row2[retired] == 1) echo "정년퇴직자재고용";
											else if($row2[retired] == 2) echo "정년연장";
											?>
										</td>
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" style="table-layout:fixed">
									...
									<tr>
										...
										<td class="tdrow"><input type="checkbox" name="fund[0]" value="1" class="checkbox" disabled <?=$fund_chk1?>> 취업성공패키지</td>
										<td class="tdrow"><input type="checkbox" name="fund[1]" value="1" class="checkbox" disabled <?=$fund_chk2?>> 50+새일터적응지원사업</td>
										<td class="tdrow"><input type="checkbox" name="fund[2]" value="1" class="checkbox" disabled <?=$fund_chk3?>> 직업교육훈련 프로그램</td>
										<td class="tdrow"><input type="checkbox" name="fund[3]" value="1" class="checkbox" disabled <?=$fund_chk4?>> 고령자 취업능력향상프로그램</td>
									</tr>
									<tr>
										<td class="tdrow"><input type="checkbox" name="fund[4]" value="1" class="checkbox" disabled <?=$fund_chk5?>> 시험고용 프로그램</td>
										<td class="tdrow"><input type="checkbox" name="fund[5]" value="1" class="checkbox" disabled <?=$fund_chk6?>> 직업능력개발훈련 프로그램</td>
										<td class="tdrow"><input type="checkbox" name="fund[6]" value="1" class="checkbox" disabled <?=$fund_chk7?>> 직업재활 프로그램</td>
										<td class="tdrow"><input type="checkbox" name="fund[7]" value="1" class="checkbox" disabled <?=$fund_chk8?>> 학업중단 청소년 자립/학습지원 사업</td>
									</tr>
									<tr>
										<td class="tdrow"><input type="checkbox" name="fund[8]" value="1"  class="checkbox" disabled <?=$fund_chk9?> > 자활근로(지방자체단체)</td>
										<td class="tdrow"><input type="checkbox" name="fund[9]" value="1"  class="checkbox" disabled <?=$fund_chk10?>> 희망리본 프로젝트</td>
										<td class="tdrow"><input type="checkbox" name="fund[10]" value="1" class="checkbox" disabled <?=$fund_chk11?>> 출소자 허그일자리 지원 프로그램</td>
										<td class="tdrow"><input type="checkbox" name="fund[11]" value="1" class="checkbox" disabled <?=$fund_chk12?>> 전직기본교육(한국보훈복지의료공단)</td>
									</tr>
								</table>
									...
									<td style="text-align:center">
										...
										<table border=0 cellpadding=0 cellspacing=0 style="display: inline;">
											<tr>
												<td width=2></td>
												<td><img src=images/btn_lt.gif></td>
												<td background=images/btn_bg.gif class=ftbutton1 nowrap><a href="staff_history.php?page=<?=$page?>" target="">목 록</a></td>
												<td><img src=images/btn_rt.gif></td>
											 <td width=2></td>
											</tr>
										</table>
