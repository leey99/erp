...
if($frm == "file") {
?>			
			$('#file_comp_bznb',opener.document).val(value.split("_")[0]);
			$('#file_comp_name',opener.document).val(value.split("_")[1]);
			$('#file_comp_adr', opener.document).val(value.split("_")[2]);
			$('#file_comp_tel', opener.document).val(value.split("_")[3]);
			$('#file_comp_email', opener.document).val(value.split("_")[4]);
			$('#file_comp_fax', opener.document).val(value.split("_")[5]);
			$('#file_boss_name', opener.document).val(value.split("_")[6]);
<?
} else {
?>
			...
			$('#boss_name', opener.document).val(value.split("_")[6]);
			opener.adjustment_member();
<?
}
?>
			self.close();
...
$code_var = $row_a4['biz_no']."_".$row_a4['com_name']."_".$row_a4['com_juso']." ".$row_a4['com_juso2']."_".$row_a4['com_tel']."_".$row_a4['com_mail']."_".$row_a4['com_fax']."_".$row_a4['boss_name'];
