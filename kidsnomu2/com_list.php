...
<? } ?>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable" style="table-layout:fixed;">
								<tr>
									...
									<td nowrap class="tdhead_center" width="98">법인등록번호</td>
									<td nowrap class="tdhead_center" width="94">사업장전화</td>
									<td nowrap class="tdhead_center" width="190">사업장주소</td>
									<td nowrap class="tdhead_center" width="52">고용보험</td>
									<td nowrap class="tdhead_center" width="52">산재보험</td>
...
?>
								<tr class="list_row_now_wh" onMouseOver="this.className='list_row_over';" onMouseOut="this.className='list_row_now_wh';">
									...
									<td nowrap class="ltrow1_center_h22"><?=$row[bupin_no]?></td>
									<td nowrap class="ltrow1_center_h22"><?=$row[com_tel]?></td>
									<td nowrap class="ltrow1_left_h22"><?=$com_juso?></td>
									<td nowrap class="ltrow1_center_h22"><?=$row[total_workercnt]?>명</td>
									<td nowrap class="ltrow1_center_h22"><?=$row[sj_workercnt]?>명</td>
