					...
					<tr>
						<td valign="top" width="270">
							<table border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									<td><a href="staff_list.php" onmouseover="limg2.src='images/menu02_sub02_on.gif'" onmouseout="limg2.src='images/menu02_sub02_off.gif'"><img src="images/menu02_sub02_off.gif" name="limg2" id="limg2" /></a></td>
								</tr>
							</table>
<?
...
?>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable" style="table-layout:fixed;">
								<tr>
									...
									<td nowrap class="tdhead_center" width="70">변경횟수</td>
									<td nowrap class="tdhead_center" width="60"><a href="<?=$sort_jumin_no?>">채용형태</a></td>
									<td nowrap class="tdhead_center" width="100"><a href="<?=$sort_in_day?>">입/퇴사일</a></td>
...
?>
								<tr class="list_row_now_wh" onMouseOver="this.className='list_row_over';" onMouseOut="this.className='list_row_now_wh';">
									...
									<td nowrap class="ltrow1_center_h55"><a href="<?=$staff_url?>"><b><?=$name?></b></a></td>
