...
//휴가구분
$cause_array = array("","연차휴가(유급)","생리휴가(무급)","경조사휴가(유급)","경조사휴가(무급)","병가(유급)","병가(무급)");
...
<form name = "HwpControl" id="HwpControl" method="post">
	...
	<input type="hidden" name="vdate" value="<?=$vdate?>" title="기간" />
	<input type="hidden" name="space" value="<?=$space?> " />
	<input type="hidden" name="reason" value="<?=$reason?>" />
	<!--공통-->
	<input type="hidden" name="today" value="<?=date("Y년 m월 d일")?>" title="오늘일자"/>
