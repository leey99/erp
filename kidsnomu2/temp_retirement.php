...
//echo $is_admin;
if($is_admin == "super") {
	$sql_search = " where 1=1 and out_day != '' ";
} else {
	$sql_search = " where com_code='$com_code' and out_day != '' ";
}
	...
	if(cnt==0) {
	 ...
	 return;
		...
		if(confirm("정말 삭제하시겠습니까?")) {
			...
			frm.action="temp_retirement_delete.php";
			frm.submit();
		} else {
			return;
		}
					...
					<tr>
						<td valign="top" width="270" height="530">
							<table border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									<td><a href="temp_temp_retirement.php" onmouseover="limg3.src='images/menu03_sub03_on.gif'" onmouseout="limg3.src='images/menu03_sub03_off.gif'"><img src="images/menu03_sub03_off.gif" name="limg3" id="limg3" /></a></td>
								</tr>
							</table>
<?
...
?>
									...
									<td nowrap class="tdhead_center" width="120">휴직일</td>
									<td nowrap class="tdhead_center" width="">휴직사유</td>
									<td nowrap class="tdhead_center" width="80">휴직서식</td>
									<td nowrap class="tdhead_center" width="5%">수정</td>
									<td nowrap class="tdhead_center" width="5%">삭제</td>
								</tr>
								<?
								// 리스트 출력
								...
								<tr class="list_row_now_wh" onMouseOver="this.className='list_row_over';" onMouseOut="this.className='list_row_now_wh';">
									<td nowrap class="ltrow1_center_h22"><input type="checkbox" name="idx" value="<?=$id?>" class="no_borer"><input type="hidden" name="codex" value="<?=$code?>"></td>
<?
if($is_admin == "super") {
?>
...
<? } ?>
									...
									<td nowrap class="ltrow1_center_h22"><a href="temp_retirement_view.php?w=u&id=<?=$row[sabun]?>&code=<?=$row[com_code]?>&page=<?=$page?>"><b><?=$name?></b></a></td>
									...
									<td nowrap class="ltrow1_center_h22"><?=$temp_retirement_day?></td>
									<td nowrap class="ltrow1_center_h22"><?=$temp_retirement_reason?></td>
									<td nowrap class="ltrow1_center_h22">
										<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=images/btn_lt.gif></td><td background=images/btn_bg.gif class=ftbutton1 nowrap><a href="#?id=<?=$id?>&code=<?=$code?>" onclick="return false;">휴직서식</a></td><td><img src=images/btn_rt.gif></td><td width=2></td></tr></table> 
									</td>
									<td nowrap class="ltrow1_center_h22">
										<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=images/btn_lt.gif></td><td background=images/btn_bg.gif class=ftbutton1 nowrap><a href="#?w=u&id=<?=$id?>&code=<?=$code?>&page=<?=$page?>" target="">수정</a></td><td><img src=images/btn_rt.gif></td><td width=2></td></tr></table> 
									</td>
									<td nowrap class="ltrow1_center_h22">
										<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=images/btn_lt.gif></td><td background=images/btn_bg.gif class=ftbutton1 nowrap><a href="#?id=<?=$id?>&code=<?=$code?>&page=<?=$page?>" target="">삭제</a></td><td><img src=images/btn_rt.gif></td><td width=2></td></tr></table> 
									</td>
								</tr>
								</tr>
								<?
									...
									<td align="left">
										...
										<table border=0 cellpadding=0 cellspacing=0 style="display:inline;">
											<tr>
												<td width=2></td>
												<td><img src=images/btn_lt.gif></td>
												<td background=images/btn_bg.gif class=ftbutton1 nowrap><a href="#?page=<?=$page?>" target="">휴직등록</a></td>
												<td><img src=images/btn_rt.gif></td>
											 <td width=2></td>
											</tr>
										</table>
