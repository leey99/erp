...
?>
									...
									<td nowrap class="tdhead_center" width="100">지급일자</td>
									<td nowrap class="tdhead_center" width="">메모</td>
									<td nowrap class="tdhead_center" width="80">상여금조회</td>
...
<? } ?>
									...
									<td nowrap class="ltrow1_center_h22"><a href="bonus_view.php?w=u&idx=<?=$idx?>&page=<?=$page?>"><b><?=$name?></b></a></td>
									...
									<td nowrap class="ltrow1_center_h22"><?=$bonus_day?></td>
									<td nowrap class="ltrow1_center_h22"><?=$memo?></td>
									<td nowrap class="ltrow1_center_h22">
										<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=images/btn_lt.gif></td><td background=images/btn_bg.gif class=ftbutton1 nowrap><a href="./popup_bonus.php?code=<?=$code?>&id=<?=$id?>" target="" onclick="cal_open(this.href,'popup_bonus',800,400);return false;">상여금조회</a></td><td><img src=images/btn_rt.gif></td><td width=2></td></tr></table> 
									</td>
									<td nowrap class="ltrow1_center_h22">
										<table border=0 cellpadding=0 cellspacing=0 style=display:inline;><tr><td width=2></td><td><img src=images/btn_lt.gif></td><td background=images/btn_bg.gif class=ftbutton1 nowrap><a href="bonus_view.php?w=u&idx=<?=$idx?>&page=<?=$page?>" target="">수정</a></td><td><img src=images/btn_rt.gif></td><td width=2></td></tr></table> 
									</td>
								</tr>
								</tr>
								<?
...
if($member['mb_level'] == 6) {
	...
	$url_form = "form_inspect.php?labor=bonus_pay_ledger";
}
?>
									...
									<td align="left">
										...
										<table border=0 cellpadding=0 cellspacing=0 style="display:inline;">
											<tr>
												<td width=2></td>
												<td><img src=images/btn_lt.gif></td>
												<td background=images/btn_bg.gif class=ftbutton1 nowrap><a href="<?=$url_view?>" target="">상여금등록</a></td>
												<td><img src=images/btn_rt.gif></td>
											 <td width=2></td>
											</tr>
										</table>
										<table border=0 cellpadding=0 cellspacing=0 style="display:inline;">
											<tr>
												<td width=2></td>
												<td><img src=images/btn_lt.gif></td>
												<td background=images/btn_bg.gif class=ftbutton1 nowrap><a href="<?=$url_form?>" target="">상여금지급대장</a></td>
												<td><img src=images/btn_rt.gif></td>
											 <td width=2></td>
											</tr>
										</table>
