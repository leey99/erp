...
<input type="hidden" name="retire_reason" value="<?=$retire_reason?> " title="퇴직사유" />
...
<input type="hidden" name="jdate" value="" title="입사일" />
<input type="hidden" name="job_grade" value=" " title="호봉"/>
<input type="hidden" name="edate" value=" " title="퇴직일" />
<input type="hidden" name="retire_reason" value=" " title="퇴직사유" />
<input type="hidden" name="tel" value=" " title="전화번호" />
<input type="hidden" name="cel" value=" " title="핸드폰번호" />
<?
}
?>
	<!-- 한글 컨트롤 폼 -->
