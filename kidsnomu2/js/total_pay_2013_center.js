...
function OnStart(){
	...
	if(pay_count > 10 && pay_count < 33) pay_table = 'total_pay_center_2013_2page.hwp';
	else if(pay_count > 32 && pay_count < 55) pay_table = 'total_pay_center_2013_3page.hwp';
	else if(pay_count > 54) pay_table = 'total_pay_center_2013_4page.hwp';
	else pay_table = 'total_pay_center_2013.hwp';
