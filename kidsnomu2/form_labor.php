...
?>
	<div style="border:0 solid red;height:165px;width:100%">
		<div style="margin:5px 0 10px 10px;background-image:url('./images/tab_labor_bg01.gif');background-repeat:no-repeat;width:136px;height:152px;float:left">
			...
			<!--<div style="padding:0 0 0 25px;"   ><a href="form_labor.php" onmouseover='getId("labor_bt3").src="./images/tab01_icon03_on.png";' onmouseout='getId("labor_bt3").src="./images/tab01_icon03_off.png";' onclick="toggleLayer('employeeList','pay_private');return false;"><img src="./images/tab01_icon03_off.png" border="0" name="labor_bt3" id="labor_bt3"></a></div>-->
	...
	<div style="height:25px;">
		<!-- 근로자리스트사항 -->
		<div id="employeeList" class="hide" style="margin-top:0;width:250px;float:left;"> 근로자 선택 :
...
?>
	...
	<div id="employeeList_text" style="margin:6px 0 0 0;clear:left;">
<?
if($employee) {
