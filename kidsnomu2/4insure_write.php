...
// 수정 상태만 작동
if($w == "u") {
	$sql1 = "select * from $g4[insure_table] where id = $id";
...
*/
		...
		if(frm.quit_note.value == "") {
			alert("구체적인 퇴직사유를 입력하세요.");
			frm.quit_note.focus();
			return;
		}
	}
...
function getCont( id ) {
	...
	xmlhttp.open('POST', 'popup/ajax_check_comp_bznb_confirm.php?id='+id, false);
							...
							<input type="hidden" name="quit_count" value="2">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" style="table-layout:fixed">
									...
									<tr>
										...
										<td nowrap class="tdrow">
											<input name="comp_adr" type="text" class="textfm" style="width:260px;" value="<?=$row1[comp_adr]?>" maxlength="25">
										</td>
									</tr>
									<tr>
										<td nowrap class="tdrowk"><img src="images/icon_02.gif" width="2" height="2" style="margin:0 5 3 0">사업자등록번호<font color="red">*</font></td>
										<td nowrap class="tdrow">
											<input name="comp_bznb" type="text" class="textfm" style="width:150px;" value="<?=$row1[comp_bznb]?>" maxlength="12" onblur="getCont(this.value)" />
								...
								<div style="height:10px;font-size:0px;line-height:0px;"></div>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1" class="bgtable1" style="table-layout:fixed">
										...
										<col width="10%">
										<tr>
											<td nowrap class="tdrowk" colspan="2"><img src="images/icon_02.gif" width="2" height="2" style="margin:0 5 3 0">성명<font color="red">*</font></td>
...
for($i=0; $row_sabun=sql_fetch_array($result_sabun); $i++) {
	...
	//월임금 (비과세 제외)
	$money_month_base = (int)$row_sabun_opt2['money_month_base'];
	$money_e1 = (int)$row_sabun_opt2['money_e1'];
	$money_e2 = (int)$row_sabun_opt2['money_e2'];
	$money_e3 = (int)$row_sabun_opt2['money_e3'];
	$money_e4 = (int)$row_sabun_opt2['money_e4'];
	$money_e = $money_e1 + $money_e2 + $money_e3 + $money_e4;
	$money_base = $money_month_base - $money_e;
?>
													<option value='<?=$row_sabun['sabun']?>_<?=$row_sabun['name']?>_<?=$row_sabun['jumin_no']?>_<?=$row_sabun['in_day']?>_<?=$row_sabun_opt['jikjong_code']?>_<?=$row_sabun_opt['jikjong']?>_<? if($row_sabun_opt2['workhour_day_w']) echo $row_sabun_opt2['workhour_day_w'];?>_<? if($money_base) echo number_format($money_base); ?>_<?=$row_sabun['apply_gy']?>_<?=$row_sabun['apply_sj']?>_<?=$row_sabun['apply_km']?>_<?=$row_sabun['apply_gg']?>'><?=$row_sabun['name']?> (<?=$row_sabun['in_day']?>)</option>
<?
	//사원 선택 Select Box 변수 저장
	$sabun_array .= "<option value='".$row_sabun['sabun']."_".$row_sabun['name']."_".$row_sabun['jumin_no']."_".$row_sabun['in_day']."_".$row_sabun_opt['jikjong_code']."_".$row_sabun_opt['jikjong']."_".$row_sabun_opt2['workhour_day_w']."_".number_format($money_base)."_".$row_sabun['apply_gy']."_".$row_sabun['apply_sj']."_".$row_sabun['apply_km']."_".$row_sabun['apply_gg']."'>".$row_sabun['name']." (".$row_sabun['in_day'].")</option>";
}
?>
												</select>
											</td>
											<td nowrap class="tdrowk" colspan="2"><img src="images/icon_02.gif" width="2" height="2" style="margin:0 5 3 0">주민등록번호<font color="red">*</font></td>
											<td nowrap class="tdrow" colspan="2">
												<input name="join_ssnb" type="text" class="textfm" style="width:100px;" value="<?=$row1[join_ssnb]?>" maxlength="14"> 예) 123456-1234567
											</td>
										</tr>
										<tr>
											<td nowrap class="tdrowk" colspan="2"><img src="images/icon_02.gif" width="2" height="2" style="margin:0 5 3 0">입사일<font color="red">*</font></td>
											<td nowrap class="tdrow" colspan="2">
											...
											<td nowrap class="tdrowk" colspan="2"><img src="images/icon_02.gif" width="2" height="2" style="margin:0 5 3 0">직종<font color="red">*</font></td>
											<td nowrap class="tdrow" colspan="2">
										...
										<tr>
											<td nowrap class="tdrowk" colspan="2"><img src="images/icon_02.gif" width="2" height="2" style="margin:0 5 3 0">주소정근로시간<font color="red">*</font></td>
											<td nowrap class="tdrow" colspan="2">
												<input name="join_time" type="text" class="textfm" style="width:100px;" value="<?=$row1[join_time]?>" maxlength="4">
											</td>
											<td nowrap class="tdrowk" colspan="2"><img src="images/icon_02.gif" width="2" height="2" style="margin:0 5 3 0">월임금<font color="red">*</font></td>
											<td nowrap class="tdrow" colspan="2">
										...
										<tr>
											<td class="tdrowk tdrow_h55" colspan="2"><img src="images/icon_02.gif" width="2" height="2" style="margin:0 5 3 0">보험적용여부<font color="red">*</font></td>
											<td class="tdrow tdrow_h55" colspan="2">
												<?
												//echo $row1[isgy];
											...
											<td class="tdrowk tdrow_h55" colspan="2"><img src="images/icon_02.gif" width="2" height="2" style="margin:0 5px 3px 0">계약직 여부<font color="red">*</font></td>
											<td class="tdrow tdrow_h55" colspan="2">
										...
										<tr>
											<td nowrap class="tdrowk" colspan="2"><img src="images/icon_02.gif" width="2" height="2" style="margin:0 5 3 0">비고<font color="red"></font></td>
...
?>
									...
									for($i=2; $i<=5; $i++) {
										...
										$quit_cause_text_add = "quit_cause_text_".$i;
									...
									quit_cause_text[<?=$i?>] = "<?=$row1[$quit_cause_text_add]?>";
									<?
									$quit_cause[$i] = $row1[$quit_cause_add];
									?>
...
frm.quit_cause.value = "<?=$row_nomu[quit_cause]?>";
<?
	}
}
?>
									...
									function join_plus(n){
										...
										if(frm.join_count.value > 5) {
											...
											tCell.className = "tdrow"; 
											tCell.colSpan = 2;
											tCell.innerHTML = "<input type=\"checkbox\" name=\"isgy_[]\" id=\"isgy_"+n+"\" value=\"1\" class=\"checkbox\" "+isgy[n]+" /> 고용 <input type=\"checkbox\" name=\"issj_[]\" id=\"issj_"+n+"\" value=\"1\" class=\"checkbox\" "+issj[n]+"> 산재 <input type=\"checkbox\" name=\"iskm_[]\" id=\"iskm_"+n+"\" value=\"1\" class=\"checkbox\" "+iskm[n]+"> 연금 <input type=\"checkbox\" name=\"isgg_[]\" id=\"isgg_"+n+"\" value=\"1\" class=\"checkbox\" "+isgg[n]+"> 건강";
											tCell = tRow.insertCell();
											tCell.className = "tdrowk"; 
											tCell.colSpan = 2;
											tCell.innerHTML = "<img src=\"images/icon_02.gif\" width=\"2\" height=\"2\" style=\"margin:0 5 3 0\">계약직 여부<font color=\"red\">*</font>";
											tCell = tRow.insertCell();
											tCell.className = "tdrow tdrow_h55";
											tCell.colSpan = 2;
									...
									<table border=0 cellspacing=0 cellpadding=0> 
										<tr> 
											<td id="" style="background-color:#8db41d" valign="top"> 
												<table border=0 cellpadding=0 cellspacing=0> 
													<tr> 
														<td><img src="images/g_tab_on_lt.gif"></td> 
...
for($i=0; $row_sabun=sql_fetch_array($result_sabun); $i++) {
	...
	//$row_sabun_opt2 = sql_fetch($sql_sabun_opt2);
?>
													<option value='<?=$row_sabun['sabun']?>_<?=$row_sabun['name']?>_<?=$row_sabun['jumin_no']?>_<?=$row_sabun['out_day']?>_<?=$row_sabun_opt['emp_cel']?>'><?=$row_sabun['name']?> (<?=$row_sabun['in_day']?>)</option>
<?
	//사원 선택 Select Box 변수 저장
	$sabun_quit_array .= "<option value='".$row_sabun['sabun']."_".$row_sabun['name']."_".$row_sabun['jumin_no']."_".$row_sabun['out_day']."_".$row_sabun_opt['emp_cel']."'>".$row_sabun['name']." (".$row_sabun['in_day'].")</option>";
}
?>
												</select>
											</td>
											...
											<td nowrap class="tdrow">
												<input name="quit_ssnb" type="text" class="textfm" style="width:100px;" value="<?=$row1[quit_ssnb]?>" maxlength="14"> 예) 123456-1234567
											</td>
										</tr>
										<tr>
											<td nowrap class="tdrowk"><img src="images/icon_02.gif" width="2" height="2" style="margin:0 5 3 0">전화번호<font color="red">*</font></td>
											...
											<td nowrap class="tdrow">
												<input name="quit_date" type="text" class="textfm5" readonly style="width:80px;" value="<?=substr($row1[quit_date], 0, 11);?>" maxlength="25">
										...
										<tr>
											...
											<td nowrap class="tdrow" colspan="3">
												<input name="quit_cause" id="quit_cause_undefined" value="<?=$row1['quit_cause']?>" type="text" class="textfm" style="width:30px;" value="" maxlength="3" readonly />
												<input name="quit_cause_text" id="quit_cause_text_undefined" value="<?=$row1['quit_cause_text']?>" type="text" class="textfm" style="width:320px;" value="" maxlength="25" readonly />
										...
										<tr>
											<td nowrap class="tdrowk"><img src="images/icon_02.gif" width="2" height="2" style="margin:0 5 3 0">퇴직전3개월간 월평균임금<font color="red"></font></td>
											<td nowrap class="tdrow">
...
?>
											...
											<td nowrap class="tdrowk"><img src="images/icon_02.gif" width="2" height="2" style="margin:0 5 3 0">구체적인 퇴직사유<font color="red">*</font></td>
											<td nowrap class="tdrow">
												<input name="quit_note" type="text" class="textfm" style="width:100%;" value="<?=$row1[quit_note]?>" maxlength="25">
											</td>
										</tr>
									</table>
									<div style="height:5px;font-size:0px;line-height:0px;"></div>
...
function quit_plus(n){
	...
	if(frm.quit_count.value > 5) {
		...
		var quit_cause_select13 = new Array();
		var quit_cause_select14 = new Array();
		var quit_cause_select15 = new Array();
		var quit_cause_select22 = new Array();
		var quit_cause_select23 = new Array();
		var quit_cause_select24 = new Array();
		...
		var quit_cause_select33 = new Array();
		var quit_cause_select41 = new Array();
		var quit_cause_select42 = new Array();
...
?>
		...
		else if(quit_cause[<?=$i?>] == "13") quit_cause_select13[<?=$i?>] = "selected";
		else if(quit_cause[<?=$i?>] == "14") quit_cause_select14[<?=$i?>] = "selected";
		else if(quit_cause[<?=$i?>] == "15") quit_cause_select15[<?=$i?>] = "selected";
		else if(quit_cause[<?=$i?>] == "22") quit_cause_select22[<?=$i?>] = "selected";
		else if(quit_cause[<?=$i?>] == "23") quit_cause_select23[<?=$i?>] = "selected";
		else if(quit_cause[<?=$i?>] == "24") quit_cause_select24[<?=$i?>] = "selected";
		else if(quit_cause[<?=$i?>] == "25") quit_cause_select25[<?=$i?>] = "selected";
		...
		else if(quit_cause[<?=$i?>] == "33") quit_cause_select33[<?=$i?>] = "selected";
		else if(quit_cause[<?=$i?>] == "41") quit_cause_select41[<?=$i?>] = "selected";
		else if(quit_cause[<?=$i?>] == "42") quit_cause_select42[<?=$i?>] = "selected";
...
?>
		...
		tCell.className = "tdrow"; 
		tCell.colSpan = 3;
		tCell.innerHTML = "<input name=\"quit_cause_[]\" id=\"quit_cause_"+n+"\" value=\""+quit_cause[n]+"\" type=\"text\" class=\"textfm\" style=\"width:30px;\" value=\"\" maxlength=\"3\" readonly /><input name=\"quit_cause_text_[]\" id=\"quit_cause_text_"+n+"\" value=\""+quit_cause_text[n]+"\" type=\"text\" class=\"textfm\" style=\"width:320px;\" value=\"\" maxlength=\"25\" readonly /><label onclick=\"open_quit_cause("+n+");\" style=\"cursor:pointer\"><img src=\"images/search_bt.png\" align=absmiddle></label>";
		...
		tCell = tRow.insertCell();
		tCell.className = "tdrowk"; 
		tCell.innerHTML = "<img src=\"images/icon_02.gif\" width=\"2\" height=\"2\" style=\"margin:0 5 3 0\">퇴직전3개월간 월평균임금<font color=\"red\"></font>";
		tCell = tRow.insertCell();
		tCell.className = "tdrow"; 
		tCell.innerHTML = "<input name=\"quit_3month_[]\" type=\"text\" class=\"textfm\" style=\"width:130px;ime-mode:inactive;\" onkeypress=\"only_number()\" value=\""+quit_3month[n]+"\" maxlength=\"25\" onkeyup=\"checkThousand(this.value, '3"+frm.quit_count.value+"','Y')\">";
		tCell = tRow.insertCell();
		tCell.className = "tdrowk"; 
		tCell.innerHTML = "<img src=\"images/icon_02.gif\" width=\"2\" height=\"2\" style=\"margin:0 5 3 0\">전년도임금총액<font color=\"red\">*</font>";
		tCell = tRow.insertCell();
		tCell.className = "tdrow"; 
		tCell.innerHTML = "<input name=\"quit_sum_pre_[]\" type=\"text\" class=\"textfm\" style=\"width:130px;ime-mode:inactive;\" onkeypress=\"only_number()\" value=\""+quit_sum_pre[n]+"\" maxlength=\"25\" onkeyup=\"checkThousand(this.value, '4"+frm.quit_count.value+"','Y')\"> 산정월수 <input name=\"quit_sum_pre_month_[]\" type=\"text\" class=\"textfm\" style=\"width:30px;ime-mode:inactive;\" onkeypress=\"only_number()\" value=\""+quit_sum_pre_month[n]+"\" maxlength=\"2\">";
		...
		tCell = tRow.insertCell();
		tCell.className = "tdrowk_end"; 
		tCell.innerHTML = "<img src=\"images/icon_02.gif\" width=\"2\" height=\"2\" style=\"margin:0 5 3 0\">구체적인 퇴직사유<font color=\"red\">*</font>";
		tCell = tRow.insertCell();
		tCell.className = "tdrow_end"; 
